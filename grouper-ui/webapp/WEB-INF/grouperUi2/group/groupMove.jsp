...
Not Support
            <%--&lt;%&ndash; for the new group or new stem button &ndash;%&gt;--%>
              ...
              <%--<div class="span12">--%>
                ...
                <%--<form class="form-horizontal" name="groupMoveFormName" id="groupCopyFormId">--%>
                  <%--<div class="control-group">--%>
                    ...
                    <%--<div class="controls">--%>
                      <%----%>
                      <%--&lt;%&ndash; placeholder: Enter a folder name &ndash;%&gt;--%>
                      <%--<grouper:combobox2 idBase="parentFolderCombo" style="width: 30em"--%>
                        <%--filterOperation="../app/UiV2Stem.createGroupParentFolderFilter"/>--%>
                      <%----%>
                      <%--&lt;%&ndash; a href="#folder-search" role="button" data-toggle="modal" class="btn"><i class="fa fa-search"></i></a &ndash;%&gt;--%>
