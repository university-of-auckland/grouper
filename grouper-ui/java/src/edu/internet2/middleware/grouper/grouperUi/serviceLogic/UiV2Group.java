...
public class UiV2Group {
   ...
   * @param response
   */
  public void thisGroupMembersPrivilegesInheritedFromFolders(HttpServletRequest request,
   ...
   * @param response
   */
  public void thisGroupsPrivilegesInheritedFromFolders(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (!GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
          .isCanReadPrivilegeInheritance()) {
        throw new RuntimeException("Not allowed to read privilege inheritance! "
            + GrouperUtil.subjectToString(loggedInSubject));
      }

      GuiResponseJs guiResponseJs = GuiResponseJs.retrieveGuiResponseJs();

      RulesContainer rulesContainer = GrouperRequestContainer
          .retrieveFromRequestOrCreate().getRulesContainer();

      Set<GuiRuleDefinition> guiRuleDefinitions = new TreeSet<GuiRuleDefinition>();
      {
        Set<RuleDefinition> groupRuleDefinitions = RuleFinder
            .findGroupPrivilegeInheritRules(group.getParentStem());
      ...
      for (GuiRuleDefinition guiRuleDefinition : guiRuleDefinitions) {
        if (StringUtils.equals(group.getParentStem().getUuid(),
            guiRuleDefinition.getOwnerGuiStem().getStem().getUuid())) {
      ...
      guiResponseJs
          .addAction(GuiScreenAction.newInnerHtmlFromJsp("#grouperMainContentDivId",
  ...
  public void viewGroup(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (retrieveGroupHelper(request, AccessPrivilege.UPDATE, false)
          .getGroup() != null) {
   ...
   * @param response
   */
  public void removeMemberForThisGroupsMemberships(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (ownerGroup == null) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteMemberCantFindOwnerGroup")));
        ...
        if (madeChanges) {
          ...
          guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
              TextContainer.retrieveFromRequest().getText()
                  .get("groupDeleteFromOwnerSuccess")));
          ...
          guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
              TextContainer.retrieveFromRequest().getText()
                  .get("groupDeleteFromOwnerNoChangesSuccess")));
      ...
      GrouperUserDataApi.recentlyUsedGroupAdd(
   ...
   * @param response
   */
  public void removeMembersForThisGroupsMemberships(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (membershipsIds.size() == 0) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("thisGroupsMembershipsRemoveNoGroupsSelects")));
        return;
      }
      int successes = 0;
      int failures = 0;
      ...
      for (String membershipId : membershipsIds) {
        try {
          Membership membership = new MembershipFinder().addMembershipId(membershipId)
              .findMembership(true);
          ...
          LOG.warn(
              "Error with membership: " + membershipId + ", user: " + loggedInSubject, e);
          failures++;
        }
      }
      ...
      if (failures > 0) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteFromOwnerErrors")));
      } else {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteFromOwnerSuccesses")));
      }
  ...
  public void removeMember(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (member == null) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteMemberCantFindMember")));
        ...
        if (madeChanges) {
          ...
          guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
              TextContainer.retrieveFromRequest().getText()
                  .get("groupDeleteMemberNoChangesSuccess")));
      ...
      GrouperUserDataApi.recentlyUsedMemberAdd(
          GrouperUiUserData.grouperUiGroupNameForUserData(),
   ...
   * @param group
   */
  private void filterHelper(HttpServletRequest request, HttpServletResponse response,
      Group group) {

    GrouperRequestContainer grouperRequestContainer = GrouperRequestContainer
    ...
    groupContainer.setGuiMembershipSubjectContainers(
  ...
  public void addMemberFilter(HttpServletRequest request, HttpServletResponse response) {
    ...
    DojoComboLogic.logic(request, response, new DojoComboQueryLogicBase<Subject>() {
       ...
       */
      @Override
      public Subject lookup(HttpServletRequest localRequest,
          GrouperSession grouperSession, String query) {
        ...
        try {
          ...
          if (query != null && query.contains("||")) {
            ...
            subject = SubjectFinder.findByIdOrIdentifierAndSource(subjectId, sourceId,
                false);
          } else {
            try {

              final String requireSources = GrouperUiConfig.retrieveConfig()
                  .propertyValueString(
              ...
              if (!StringUtils.isBlank(requireSources)) {
                ...
                subject = SubjectFinder.findByIdOrIdentifierAndSource(query, sources,
                    false);
              } else {
       ...
       */
      @Override
      public Collection<Subject> search(HttpServletRequest localRequest,
          GrouperSession grouperSession, String query) {

        Group group = UiV2Group
            .retrieveGroupHelper(localRequest, AccessPrivilege.UPDATE, false).getGroup();
        String stemName = null;
        if (group == null) {
          Stem stem = UiV2Stem.retrieveStemHelper(localRequest, true, false, false)
              .getStem();
       ...
       */
      @Override
      public String initialValidationError(HttpServletRequest localRequest,
  ...
  public void addMemberSearch(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      Group group = retrieveGroupHelper(request, AccessPrivilege.UPDATE, false)
          .getGroup();
      String stemName = null;
      if (group != null) {
        stemName = group.getParentStemName();
        ...
        if (stem != null) {
          ...
          AttributeDef attributeDef = UiV2AttributeDef
              .retrieveAttributeDefHelper(request, AttributeDefPrivilege.ATTR_ADMIN, true)
              .getAttributeDef();
      ...
      if (!searchOk) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newInnerHtml("#addMemberResults",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAddMemberNotEnoughChars")));
        return;
      }
      ...
      if (matchExactId) {
        if (GrouperConfig.retrieveConfig().propertyValueBoolean(
            "grouperQuerySubjectsMultipleQueriesCommaSeparated", true)) {
          Set<String> searchStrings = GrouperUtil.splitTrimToSet(searchString, ",");
          if (StringUtils.equals("all", sourceId)) {
            subjects = new LinkedHashSet<Subject>(GrouperUtil
                .nonNull(SubjectFinder.findByIdsOrIdentifiers(searchStrings)).values());
          } else {
            subjects = new LinkedHashSet<Subject>(GrouperUtil
                .nonNull(SubjectFinder.findByIdsOrIdentifiers(searchStrings, sourceId))
                .values());
          }
        } else {
          Subject subject = null;
          if (StringUtils.equals("all", sourceId)) {
            ...
            subject = SubjectFinder.findByIdOrIdentifierAndSource(searchString, sourceId,
                false);
          }
        ...
        if (StringUtils.equals("all", sourceId)) {
          ...
          Set<Source> sources = GrouperUtil
              .toSet(SourceManager.getInstance().getSource(sourceId));
          if (group != null) {
            subjects = SubjectFinder.findPageInStem(stemName, searchString, sources)
                .getResults();
          } else {
      ...
      if (GrouperUtil.length(subjects) == 0) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newInnerHtml("#addMemberResults",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAddMemberNoSubjectsFound")));
        return;
      }

      Set<GuiSubject> guiSubjects = GuiSubject.convertFromSubjects(subjects,
  ...
  */
   ...
   * @param response
   */
  public void addMemberSubmit(final HttpServletRequest request,
    ...
    try {
...

      {
        ...
        if (StringUtils.equals(privilegeOptionsValue, "default")) {
          ...
          throw new RuntimeException(
              "For privilege-options expecting default or custom but was: '"
                  + privilegeOptionsValue + "'");
        }
      }

      boolean memberChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_members[]"), false);
      boolean adminChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_admins[]"), false);
      boolean updateChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_updaters[]"), false);
      boolean readChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_readers[]"), false);
      boolean viewChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_viewers[]"), false);
      boolean optinChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_optins[]"), false);
      boolean optoutChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_optouts[]"), false);
      boolean attrReadChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_groupAttrReaders[]"), false);
      boolean attrUpdateChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_groupAttrUpdaters[]"), false);
      ...
      if (!defaultPrivs && !memberChecked && !adminChecked && !updateChecked
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#groupPrivsErrorId",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAddMemberPrivRequired")));
        return;
      ...
      boolean madeChanges = group.addOrEditMember(subject, defaultPrivs, memberChecked,
          adminChecked,
          updateChecked, readChecked, viewChecked, optinChecked, optoutChecked,
          attrReadChecked,
      ...
      if (madeChanges) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupAddMemberMadeChangesSuccess")));
        ...
        } else if (StringUtils.equals(groupRefreshPart,
            "thisGroupsAttributeDefPrivileges")) {
          //doesnt affect
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
            TextContainer.retrieveFromRequest().getText()
                .get("groupAddMemberNoChangesSuccess")));
  ...
  public void joinGroup(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(
          GuiScreenAction.newInnerHtmlFromJsp("#groupMoreActionsButtonContentsDivId",
  ...
  public void addToMyFavorites(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      GrouperUserDataApi.favoriteGroupAdd(
          GrouperUiUserData.grouperUiGroupNameForUserData(), loggedInSubject, group);

      GuiResponseJs guiResponseJs = GuiResponseJs.retrieveGuiResponseJs();

      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
          TextContainer.retrieveFromRequest().getText()
              .get("groupSuccessAddedToMyFavorites")));
   ...
   * @param response
   */
  public void removeFromMyFavorites(HttpServletRequest request,
      HttpServletResponse response) {
    final Subject loggedInSubject = GrouperUiFilter.retrieveSubjectLoggedIn();
    ...
    try {
      ...
      GrouperUserDataApi.favoriteGroupRemove(
          GrouperUiUserData.grouperUiGroupNameForUserData(), loggedInSubject, group);
      ...
      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
          TextContainer.retrieveFromRequest().getText()
              .get("groupSuccessRemovedFromMyFavorites")));
   ...
   * @param response
   */
  public void assignPrivilegeBatch(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      String groupPrivilegeBatchUpdateOperation = request
          .getParameter("groupPrivilegeBatchUpdateOperation");
      Pattern operationPattern = Pattern.compile("^(assign|revoke)_(.*)$");
      Matcher operationMatcher = operationPattern
          .matcher(groupPrivilegeBatchUpdateOperation);
      if (!operationMatcher.matches()) {
        throw new RuntimeException("Invalid submission, should have a valid operation: '"
            + groupPrivilegeBatchUpdateOperation + "'");
      }
      ...
      if (!assign && !StringUtils.equals("revoke", assignOrRevokeString)) {
        throw new RuntimeException(
            "Cant find assign or revoke: '" + assignOrRevokeString + "'");
      }
      ...
      if (changes > 0) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText().get(
                assign ? "groupSuccessGrantedPrivileges"
                    : "groupSuccessRevokedPrivileges")));
      } else {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
            TextContainer.retrieveFromRequest().getText().get(
                assign ? "groupNoteNoGrantedPrivileges"
      ...
      if (group.hasAdmin(loggedInSubject)) {
        ...
        guiResponseJs.addAction(
            GuiScreenAction.newScript("guiV2link('operation=UiV2Main.indexMain')"));
      }
   ...
   * @param response
   */
  public void filterThisGroupsMemberships(HttpServletRequest request,
      HttpServletResponse response) {
    final Subject loggedInSubject = GrouperUiFilter.retrieveSubjectLoggedIn();
   ...
   * @param group 
   */
  private void filterPrivilegesHelper(HttpServletRequest request,
    ...
    GuiPaging guiPaging = grouperRequestContainer.getGroupContainer()
    ...
    grouperRequestContainer.getGroupContainer()
        .setPrivilegeGuiMembershipSubjectContainers(
            GuiMembershipSubjectContainer
                .convertFromMembershipSubjectContainers(results));

    guiPaging.setTotalRecordCount(queryOptions.getQueryPaging().getTotalRecordCount());

    guiResponseJs
        .addAction(GuiScreenAction.newInnerHtmlFromJsp("#groupPrivilegeFilterResultsId",
  ...
  public void groupDelete(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (GrouperUiConfig.retrieveConfig()
          .propertyValueBoolean("uiV2.group.checkForFactorWhenDeletingGroup", true)) {
        ...
        if (GrouperUtil.length(composites) > 0) {
          ...
          for (Composite composite : composites) {
            ...
            try {
              ...
              result.append(TextContainer.retrieveFromRequest().getText()
                  .get("groupLabelNotAllowedToViewOwner"));
            }
          ...
          guiResponseJs.addAction(
              GuiScreenAction.newMessage(GuiMessageType.error, result.toString()));
          return;
        }
      }
   ...
   * @param response
   */
  public void groupDeleteSubmit(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      try {
        ...
        LOG.warn("Insufficient privilege exception for group delete: "
            + SubjectHelper.getPretty(loggedInSubject), ipe);

        //go to the view group screen
        guiResponseJs.addAction(GuiScreenAction.newScript(
            "guiV2link('operation=UiV2Group.viewGroup&groupId=" + group.getId() + "')"));

        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteInsufficientPrivileges")));
        return;

      } catch (GroupDeleteException sde) {

        LOG.warn("Error deleting group: " + SubjectHelper.getPretty(loggedInSubject)
            + ", " + group, sde);
      ...
      guiResponseJs.addAction(GuiScreenAction
          .newScript("guiV2link('operation=UiV2Stem.viewStem&stemId=" + stemId + "')"));

      //lets show a success message on the new screen
      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
          TextContainer.retrieveFromRequest().getText().get("groupDeleteSuccess")));

      GrouperUserDataApi.recentlyUsedGroupRemove(
          GrouperUiUserData.grouperUiGroupNameForUserData(),
          loggedInSubject, group);
  ...
  public void newGroupSubmit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      final boolean editIdChecked = GrouperUtil
          .booleanValue(request.getParameter("nameDifferentThanId[]"), false);
      final String displayExtension = request.getParameter("displayExtension");
      final String extension = editIdChecked ? request.getParameter("extension")
          : displayExtension;
      final String description = request.getParameter("description");
      final boolean adminChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_admins[]"), false);
      final boolean updateChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_updaters[]"), false);
      final boolean readChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_readers[]"), false);
      final boolean viewChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_viewers[]"), false);
      final boolean optinChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_optins[]"), false);
      final boolean optoutChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_optouts[]"), false);
      final boolean attrReadChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_groupAttrReaders[]"), false);
      final boolean attrUpdateChecked = GrouperUtil
          .booleanValue(request.getParameter("privileges_groupAttrUpdaters[]"), false);
      ...
      if (typeOfGroup != TypeOfGroup.group && typeOfGroup != TypeOfGroup.role) {
        throw new RuntimeException(
            "Invalid group type, should be group or role: " + typeOfGroup);
      }
      ...
      if (StringUtils.isBlank(parentFolderId)) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            ...
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateRequiredParentStemId")));
        return;
      }

      final Stem parentFolder = new StemFinder()
      ...
      if (parentFolder == null) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#parentFolderComboErrorId",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateCantFindParentStemId")));
        return;
      ...
      if (StringUtils.isBlank(displayExtension)) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#groupName",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateErrorDisplayExtensionRequired")));
        return;
      ...
      if (StringUtils.isBlank(extension)) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#groupId",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateErrorExtensionRequired")));
        return;
      ...
      if (parentFolder.isRootStem()) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#parentFolderComboErrorId",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateCantCreateInRoot")));
        return;
      ...
      group = (Group) GrouperSession.callbackGrouperSession(
      ...
      if (group != null) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            ...
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateCantCreateAlreadyExists")));
        return;
      }
      ...
      try {
        ...
        group = new GroupSave(grouperSession).assignName(groupName)
            ...
            .assignDisplayExtension(displayExtension).assignDescription(description)
            .assignTypeOfGroup(typeOfGroup)
        ...
        LOG.warn("Insufficient privilege exception for group create: "
            + SubjectHelper.getPretty(loggedInSubject), ipe);

        //dont change screens
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCreateInsufficientPrivileges")));
        return;

      } catch (Exception sde) {

        LOG.warn("Error creating group: " + SubjectHelper.getPretty(loggedInSubject)
            + ", " + group, sde);
  ...
  private void handleGrouperValidationException(GuiResponseJs guiResponseJs,
    ...
    if (StringUtils.equals(Group.VALIDATION_GROUP_DESCRIPTION_TOO_LONG_KEY,
        gve.getGrouperValidationKey())) {

      guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
          "#groupDescription",
          TextContainer.retrieveFromRequest().getText()
              .get("groupValidation_" + gve.getGrouperValidationKey())));
      return;

    } else if (StringUtils.equals(Group.VALIDATION_GROUP_EXTENSION_TOO_LONG_KEY,
        gve.getGrouperValidationKey())
        || StringUtils.equals(Group.VALIDATION_GROUP_NAME_TOO_LONG_KEY,
            gve.getGrouperValidationKey())) {
    ...
    } else if (StringUtils.equals(Group.VALIDATION_GROUP_DISPLAY_EXTENSION_TOO_LONG_KEY,
        gve.getGrouperValidationKey())
        || StringUtils.equals(Group.VALIDATION_GROUP_DISPLAY_NAME_TOO_LONG_KEY,
            gve.getGrouperValidationKey())) {
      ...
      LOG.error("Non-fatal error, not expecting GrouperValidationException: "
          + gve.getGrouperValidationKey(), gve);
      guiResponseJs
          .addAction(GuiScreenAction.newMessage(GuiMessageType.error, gve.getMessage()));
      return;
    }
  }
  ...
  public void groupEdit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
          .getGuiGroup().setShowBreadcrumbLink(true);
      GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
          .getGuiGroup().setShowBreadcrumbLinkSeparator(false);
  ...
  public void groupEditSubmit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      try {
        ...
        LOG.warn("Insufficient privilege exception for group edit: "
            + SubjectHelper.getPretty(loggedInSubject), ipe);
        ...
        LOG.warn("Error edit group: " + SubjectHelper.getPretty(loggedInSubject) + ", "
            + group, sde);
  ...
  public void viewAudits(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      GrouperRequestContainer grouperRequestContainer = GrouperRequestContainer
          .retrieveFromRequestOrCreate();
      grouperRequestContainer.getGroupContainer()
          .setAuditType(request.getParameter("auditType"));
  ...
  public void groupMoveSubmit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      boolean moveChangeAlternateNames = GrouperUtil
          .booleanValue(request.getParameter("moveChangeAlternateNames[]"), false);
      ...
      if (parentFolder == null) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCopyCantFindParentStemId")));
        return;
      ...
      try {
        ...
        new GroupMove(group, parentFolder).assignAlternateName(moveChangeAlternateNames)
            .save();

      } catch (InsufficientPrivilegeException ipe) {

        LOG.warn("Insufficient privilege exception for group move: "
            + SubjectHelper.getPretty(loggedInSubject), ipe);

        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupMoveInsufficientPrivileges")));
        return;
  ...
  public void groupCopySubmit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      boolean copyGroupAttributes = GrouperUtil
          .booleanValue(request.getParameter("copyGroupAttributes[]"), false);
      boolean copyListMemberships = GrouperUtil
          .booleanValue(request.getParameter("copyListMemberships[]"), false);
      boolean copyGroupPrivileges = GrouperUtil
          .booleanValue(request.getParameter("copyGroupPrivileges[]"), false);
      boolean copyListMembershipsInOtherGroups = GrouperUtil.booleanValue(
          request.getParameter("copyListMembershipsInOtherGroups[]"), false);
      boolean copyPrivsInOtherGroups = GrouperUtil
          .booleanValue(request.getParameter("copyPrivsInOtherGroups[]"), false);
      ...
      final Stem parentFolder = StringUtils.isBlank(parentFolderId) ? null
          : new StemFinder()
              .assignPrivileges(NamingPrivilege.CREATE_PRIVILEGES)
              .assignSubject(loggedInSubject)
              .assignScope(parentFolderId).assignFindByUuidOrName(true).findStem();
      ...
      try {
        ...
        LOG.warn("Insufficient privilege exception for group copy: "
            + SubjectHelper.getPretty(loggedInSubject), ipe);

        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCopyInsufficientPrivileges")));
        return;

      }

      guiResponseJs.addAction(GuiScreenAction.newScript(
          "guiV2link('operation=UiV2Group.viewGroup&groupId=" + newGroup.getId() + "')"));
   ...
   */
  public static RetrieveGroupHelperResult retrieveGroupHelper(HttpServletRequest request,
   ...
   */
  public static RetrieveGroupHelperResult retrieveGroupHelper(HttpServletRequest request,
      Privilege requirePrivilege, boolean errorIfNotFound) {
    ...
    if (!StringUtils.isBlank(groupId)) {
      ...
      if (subject != null
          && GrouperSourceAdapter.groupSourceId().equals(subject.getSourceId())) {
    ...
    if (group != null) {
      ...
      if (requirePrivilege != null) {
        if (requirePrivilege.equals(AccessPrivilege.ADMIN)
            && !groupContainer.isCanAdmin()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToAdminGroup")));
            addedError = true;
          }
          privsOk = false;
        } else if (requirePrivilege.equals(AccessPrivilege.VIEW)
            && !groupContainer.isCanView()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToViewGroup")));
            addedError = true;
          }
          privsOk = false;
        } else if (requirePrivilege.equals(AccessPrivilege.READ)
            && !groupContainer.isCanRead()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToReadGroup")));
            addedError = true;
          }
          privsOk = false;
        } else if (requirePrivilege.equals(AccessPrivilege.OPTIN)
            && !groupContainer.isCanOptin()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToOptinGroup")));
            addedError = true;
          }
          privsOk = false;
        } else if (requirePrivilege.equals(AccessPrivilege.OPTOUT)
            && !groupContainer.isCanOptout()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToOptoutGroup")));
            addedError = true;
          }
          privsOk = false;
        } else if (requirePrivilege.equals(AccessPrivilege.UPDATE)
            && !groupContainer.isCanUpdate()) {
          if (errorIfNotFound) {
            guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
                TextContainer.retrieveFromRequest().getText()
                    .get("groupNotAllowedToUpdateGroup")));
            addedError = true;
          }
          privsOk = false;
        }
      ...
      if (!addedError && (!StringUtils.isBlank(groupId) || !StringUtils.isBlank(groupName)
          || !StringUtils.isBlank(groupIndex))) {
   ...
   * @param response
   */
  public void thisGroupsMemberships(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param group 
   */
  private void filterThisGroupsMembershipsHelper(HttpServletRequest request,
      HttpServletResponse response, Group group) {
    ...
    guiResponseJs.addAction(
        GuiScreenAction.newInnerHtmlFromJsp("#thisGroupsMembershipsFilterResultsId",
  ...
  public void removeMembers(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (membershipsIds.size() == 0) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupMembershipsRemoveNoSubjectSelects")));
        return;
      }
      ...
      GrouperSession.internal_callbackRootGrouperSession(new GrouperSessionHandler() {
        ...
        public Object callback(GrouperSession grouperSession2)
            throws GrouperSessionException {
          for (String membershipId : membershipsIds) {
            try {
              Membership membership = new MembershipFinder().addMembershipId(membershipId)
              ...
              if (count[0]++ < 5 && group.canHavePrivilege(loggedInSubject,
                  AccessPrivilege.VIEW.getName(), false)) {
                GrouperUserDataApi.recentlyUsedMemberAdd(
                    GrouperUiUserData.grouperUiGroupNameForUserData(),
                    loggedInSubject, member);
              ...
              LOG.warn(
                  "Error with membership: " + membershipId + ", user: " + loggedInSubject,
                  e);
              failures[0]++;
            }
          }

          if (group.canHavePrivilege(loggedInSubject, AccessPrivilege.VIEW.getName(),
              false)) {
            GrouperUserDataApi.recentlyUsedGroupAdd(
                GrouperUiUserData.grouperUiGroupNameForUserData(),
                loggedInSubject, group);
      ...
      GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
          .setSuccessCount(successes[0]);
      GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
          .setFailureCount(failures[0]);

      if (!group.canHavePrivilege(loggedInSubject, AccessPrivilege.UPDATE.getName(),
          false)
          || !group.canHavePrivilege(loggedInSubject, AccessPrivilege.READ.getName(),
              false)) {
        guiResponseJs.addAction(
            GuiScreenAction.newScript("guiV2link('operation=UiV2Main.indexMain')"));
      } else {
      ...
      if (failures[0] > 0) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteMembersErrors")));
      } else {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupDeleteMembersSuccesses")));
      }
   ...
   * @param response
   */
  public void thisGroupsGroupPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void filterThisGroupsGroupPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
    final Subject loggedInSubject = GrouperUiFilter.retrieveSubjectLoggedIn();
   ...
   * @param group 
   */
  private void filterThisGroupsGroupPrivilegesHelper(HttpServletRequest request,
      HttpServletResponse response, Group group) {
    ...
    guiResponseJs.addAction(
        GuiScreenAction.newInnerHtmlFromJsp("#thisGroupsGroupPrivilegesFilterResultsId",
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignPrivilege(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (parentGroup == null || !parentGroup.canHavePrivilege(loggedInSubject,
          AccessPrivilege.ADMIN.getName(), false)) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupNotAllowedToAdminAnotherGroup")));
        filterThisGroupsGroupPrivilegesHelper(request, response, group);
        return;
      }
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignPrivilegeBatch(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      for (int i = 0; i < pageSize; i++) {
        ...
        if (!StringUtils.isBlank(parentGroupId)) {
          ...
          Group parentGroup = GroupFinder.findByUuid(grouperSession, parentGroupId,
              false);
      ...
      if (GrouperUtil.length(parentGroups) == 0) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("thisGroupsPrivilegesErrorGroupRequired")));
        guiResponseJs.addAction(GuiScreenAction.newScript("guiScrollTop()"));
        filterThisGroupsGroupPrivilegesHelper(request, response, group);
        return;
      }
      ...
      Privilege[] privileges = assignAll ? (assign ? new Privilege[] {
          ...
          : (readersUpdaters
              ? new Privilege[] { AccessPrivilege.listToPriv(Field.FIELD_NAME_READERS),
                  AccessPrivilege.listToPriv(Field.FIELD_NAME_UPDATERS)
              }
      ...
      for (Group parentGroup : parentGroups) {
        ...
        for (Privilege privilege : privileges) {
          if (assign) {
            ...
            changes += parentGroup.revokePriv(group.toSubject(), privilege, false) ? 1
                : 0;
          }
        }
      }
   ...
   * @param response
   */
  public void filterThisGroupsStemPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
    final Subject loggedInSubject = GrouperUiFilter.retrieveSubjectLoggedIn();
   ...
   * @param group 
   */
  private void filterThisGroupsStemPrivilegesHelper(HttpServletRequest request,
      HttpServletResponse response, Group group) {
    ...
    guiResponseJs.addAction(
        GuiScreenAction.newInnerHtmlFromJsp("#thisGroupsStemPrivilegesFilterResultsId",
   ...
   * @param response
   */
  public void thisGroupsStemPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignStemPrivilege(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (parentStem == null || !parentStem.canHavePrivilege(loggedInSubject,
          NamingPrivilege.STEM_ADMIN.getName(), false)) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupNotAllowedToAdminAnotherStem")));
        filterThisGroupsGroupPrivilegesHelper(request, response, group);
        return;
      }
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignStemPrivilegeBatch(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (GrouperUtil.length(parentStems) == 0) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("thisGroupsPrivilegesErrorStemRequired")));
        guiResponseJs.addAction(GuiScreenAction.newScript("guiScrollTop()"));
        filterThisGroupsStemPrivilegesHelper(request, response, group);
        return;
      }
   ...
   * @param response
   */
  public void filterThisGroupsAttributeDefPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
    final Subject loggedInSubject = GrouperUiFilter.retrieveSubjectLoggedIn();
   ...
   * @param group 
   */
  private void filterThisGroupsAttributeDefPrivilegesHelper(HttpServletRequest request,
      HttpServletResponse response, Group group) {
    ...
    guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp(
        "#thisGroupsAttributeDefPrivilegesFilterResultsId",
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignAttributeDefPrivilege(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      AttributeDef parentAttributeDef = AttributeDefFinder.findById(parentAttributeDefId,
          false);

      if (parentAttributeDef == null
          || !parentAttributeDef.getPrivilegeDelegate().canHavePrivilege(loggedInSubject,
              AttributeDefPrivilege.ATTR_ADMIN.getName(), false)) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupNotAllowedToAdminAnotherAttributeDef")));
        filterThisGroupsAttributeDefPrivilegesHelper(request, response, group);
        return;
      }
      ...
      //if someone revoked in the meantime, who cares...
      if (assign) {
        parentAttributeDef.getPrivilegeDelegate().grantPriv(group.toSubject(), privilege,
            false);
        ...
        parentAttributeDef.getPrivilegeDelegate().revokePriv(group.toSubject(), privilege,
            false);
   ...
   * @param response
   */
  public void thisGroupsPrivilegesAssignAttributeDefPrivilegeBatch(
    ...
    try {
      ...
      //loop through all the checkboxes and collect all the groups
      for (int i = 0; i < pageSize; i++) {
        String parentAttributeDefId = request
            .getParameter("privilegeSubjectRow_" + i + "[]");
        if (!StringUtils.isBlank(parentAttributeDefId)) {

          AttributeDef parentAttributeDef = AttributeDefFinder
              .findById(parentAttributeDefId, false);

          if (parentAttributeDef != null
              && parentAttributeDef.getPrivilegeDelegate().canHavePrivilege(
                  loggedInSubject, AttributeDefPrivilege.ATTR_ADMIN.getName(), false)) {
      ...
      if (GrouperUtil.length(parentAttributeDefs) == 0) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("thisGroupsPrivilegesErrorAttributeDefRequired")));
        guiResponseJs.addAction(GuiScreenAction.newScript("guiScrollTop()"));
        filterThisGroupsAttributeDefPrivilegesHelper(request, response, group);
        return;
      }
      ...
      for (AttributeDef parentAttributeDef : parentAttributeDefs) {
        ...
        for (Privilege privilege : privileges) {
          if (assign) {
            changes += parentAttributeDef.getPrivilegeDelegate()
                .grantPriv(group.toSubject(), privilege, false) ? 1 : 0;
          } else {
            changes += parentAttributeDef.getPrivilegeDelegate()
                .revokePriv(group.toSubject(), privilege, false) ? 1 : 0;
          }
        }
      }
   ...
   * @param response
   */
  public void thisGroupsAttributeDefPrivileges(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void groupUpdateFilter(final HttpServletRequest request,
      HttpServletResponse response) {
    ...
    DojoComboLogic.logic(request, response, new DojoComboQueryLogicBase<Group>() {
       ...
       */
      @Override
      public Group lookup(HttpServletRequest localRequest, GrouperSession grouperSession,
          String query) {
       ...
       */
      @Override
      public Collection<Group> search(HttpServletRequest localRequest,
          GrouperSession grouperSession, String query) {
        Subject loggedInSubject = grouperSession.getSubject();

        int groupComboSize = GrouperUiConfig.retrieveConfig()
            .propertyValueInt("uiV2.groupComboboxResultSize", 200);
      ...
      public String retrieveHtmlLabel(GrouperSession grouperSession, Group t) {
        ...
        String htmlLabel = "<img src=\"../../grouperExternal/public/assets/images/group.gif\" /> "
            + label;
        return htmlLabel;
      }
   ...
   * @param group 
   */
  private void viewAuditsHelper(HttpServletRequest request, HttpServletResponse response,
      Group group) {
    ...
    if (StringUtils.equals(filterTypeString, "on")
        || StringUtils.equals(filterTypeString, "before")
        || StringUtils.equals(filterTypeString, "between")
        || StringUtils.equals(filterTypeString, "since")) {
      if (StringUtils.isBlank(filterFromDateString)) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#from-date",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAuditLogFilterFromDateRequired")));
        return;
      }
      try {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#from-date",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAuditLogFilterFromDateInvalid")));
        return;
      }
    }
    if (StringUtils.equals(filterTypeString, "between")) {
      if (StringUtils.isBlank(filterToDateString)) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#to-date",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAuditLogFilterToDateRequired")));
        return;
      }
      try {
        ...
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            "#to-date",
            TextContainer.retrieveFromRequest().getText()
                .get("groupAuditLogFilterToDateInvalid")));
        return;
      }
    }
    ...
    GrouperSession grouperSession = GrouperSession.startIfNotStarted(loggedInSubject)
        .getGrouperSession();
    ...
    if ("membership".equals(auditType)) {
      ...
      query = query.addAuditTypeCategory("privilege").addAuditTypeFieldValue("memberId",
          member.getUuid());
    } else {
    ...
    groupContainer
        .setGuiAuditEntries(GuiAuditEntry.convertFromAuditEntries(auditEntries));
    ...
    if (GrouperUtil.length(auditEntries) == 0) {
      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
          TextContainer.retrieveFromRequest().getText()
              .get("groupAuditLogNoEntriesFound")));
    }

    groupContainer.setAuditExtendedResults(extendedResults);
    guiResponseJs
        .addAction(GuiScreenAction.newInnerHtmlFromJsp("#groupAuditFilterResultsId",
   ...
   * @param response
   */
  public void groupRemoveAllMembersSubmit(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void groupRemoveAllMembers(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void leftGroupFactorSearch(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (!searchOk) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newInnerHtml("#leftFactorGroupResults",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeNotEnoughChars")));
        return;
      }
      ...
      if (GrouperUtil.length(groups) == 0) {
        ...
        guiResponseJs.addAction(GuiScreenAction.newInnerHtml("#leftFactorGroupResults",
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeSearchNoGroupsFound")));
        return;
      }
      ...
      guiResponseJs
          .addAction(GuiScreenAction.newInnerHtmlFromJsp("#leftFactorGroupResults",
   ...
   * @param response
   */
  public void groupCompositeFactorFilter(HttpServletRequest request,
      HttpServletResponse response) {
   ...
   * @param response
   */
  public void groupEditComposite(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      if (!group.canHavePrivilege(loggedInSubject, AccessPrivilege.READ.getName(),
          false)) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupNotAllowedToReadGroup")));
      ...
      if (group.isHasMembers()) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeErrorCannotHaveMembers")));
        return;
      }

      GroupContainer groupContainer = GrouperRequestContainer
          .retrieveFromRequestOrCreate().getGroupContainer();
      ...
      if (composite != null) {
        ...
        groupContainer
            .setCompositeLeftFactorGuiGroup(new GuiGroup(composite.getLeftGroup()));
        groupContainer
            .setCompositeRightFactorGuiGroup(new GuiGroup(composite.getRightGroup()));
   ...
   * @param response
   */
  public void groupReadFilter(final HttpServletRequest request,
      HttpServletResponse response) {
    ...
    DojoComboLogic.logic(request, response, new DojoComboQueryLogicBase<Group>() {
      ...
      public Group lookup(HttpServletRequest localRequest, GrouperSession grouperSession,
          String query) {
        Subject loggedInSubject = grouperSession.getSubject();
        Group theGroup = new GroupFinder()
            .assignPrivileges(AccessPrivilege.READ_PRIVILEGES)
            .assignSubject(loggedInSubject)
   ...
   * @param response
   */
  public void rightGroupFactorSearch(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs
          .addAction(GuiScreenAction.newInnerHtmlFromJsp("#rightFactorGroupResults",
   ...
   * @param response
   */
  public void groupEditCompositeSubmit(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      boolean userSelectedComposite = GrouperUtil
          .booleanValue(request.getParameter("groupComposite[]"));
      ...
      if (!userSelectedComposite) {
        ...
        if (!group.isHasComposite()) {
          ...
          guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
              TextContainer.retrieveFromRequest().getText()
                  .get("groupCompositeNoteNoChangesMade")));
          return;
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeSuccessRemovedComposite")));
      ...
      String leftFactorGroupId = request
          .getParameter("groupCompositeLeftFactorComboName");

      Group leftFactorGroup = StringUtils.isBlank(leftFactorGroupId) ? null
          : new GroupFinder()
              .assignScope(leftFactorGroupId)
              .assignPrivileges(AccessPrivilege.READ_PRIVILEGES)
      ...
      if (leftFactorGroup == null) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            ...
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeErrorLeftGroupProblem")));
        return;
      ...
      CompositeType compositeType = StringUtils.isBlank(compositeTypeString) ? null
          : CompositeType.valueOfIgnoreCase(compositeTypeString);
      ...
      if (compositeType == null) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            ...
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeErrorOperationRequired")));
        return;
      }

      // get right group and validate
      String rightFactorGroupId = request
          .getParameter("groupCompositeRightFactorComboName");

      Group rightFactorGroup = StringUtils.isBlank(rightFactorGroupId) ? null
          : new GroupFinder()
              .assignScope(rightFactorGroupId)
              .assignPrivileges(AccessPrivilege.READ_PRIVILEGES)
              .assignFindByUuidOrName(true).assignSubject(loggedInSubject).findGroup();
      ...
      if (rightFactorGroup == null) {
        guiResponseJs.addAction(GuiScreenAction.newValidationMessage(GuiMessageType.error,
            ...
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeErrorRightGroupProblem")));
        return;
      }

      //lets see if no changes
      if (composite != null
          && StringUtils.equals(composite.getLeftFactorUuid(), leftFactorGroup.getId())
          && composite.getType() == compositeType && StringUtils
              .equals(composite.getRightFactorUuid(), rightFactorGroup.getId())) {
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.info,
            TextContainer.retrieveFromRequest().getText()
                .get("groupCompositeNoteNoChangesMade")));
        return;
   ...
   * @param response
   */
  public void updateLoaderGroup(HttpServletRequest request,
      HttpServletResponse response) {

    if (!GrouperUiConfig.retrieveConfig()
        .propertyValueBoolean("uiV2.group.allowGroupAdminsToRefreshLoaderJobs", true)) {
      throw new RuntimeException(
          "Cant refresh loader groups from UI due to config param uiV2.group.allowGroupAdminsToRefreshLoaderJobs set to false");
    }
    ...
    try {
      ...
      try {
        ...
        result = (String) GrouperSession
            .internal_callbackRootGrouperSession(new GrouperSessionHandler() {

              public Object callback(GrouperSession rootGrouperSession)
                  throws GrouperSessionException {
        ...
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText().get("loaderGroupUpdateError")
                + "<br />"
                + e.getMessage()));
        return;
      }
      ...
      Pattern pattern = Pattern.compile(
          "^loader ran (successfully|with subject problems), inserted (\\d+) memberships, deleted (\\d+) memberships, total membership count: (\\d+), unresolvable subjects: (\\d+)$");
      ...
      if (matcher.matches()) {
        ...
        GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
            .setCountAdded(GrouperUtil.intValue(matcher.group(2)));
        GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
            .setCountRemoved(GrouperUtil.intValue(matcher.group(3)));
        GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
            .setCountTotal(GrouperUtil.intValue(matcher.group(4)));
        GrouperRequestContainer.retrieveFromRequestOrCreate().getGroupContainer()
            .setCountUnresolvableSubjects(GrouperUtil.intValue(matcher.group(5)));

        if (subjectProblems) {
          result = TextContainer.retrieveFromRequest().getText()
              .get("groupRunLoaderProcessResultWithSubjectProblems");
        } else {
          result = TextContainer.retrieveFromRequest().getText()
              .get("groupRunLoaderProcessResult");
        }
      }
   ...
   * @param response
   */
  public void viewAllLoaderManagedGroups(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      AttributeDefName loaderMetadataAttributeDefName = AttributeDefNameFinder
          .findByName(GrouperCheckConfig.loaderMetadataStemName() + ":"
              + GrouperLoader.ATTRIBUTE_GROUPER_LOADER_METADATA_GROUP_ID, false);
      AttributeDefName loaderMetadataLoadedAttributeDefName = AttributeDefNameFinder
          .findByName(GrouperCheckConfig.loaderMetadataStemName() + ":"
              + GrouperLoader.ATTRIBUTE_GROUPER_LOADER_METADATA_LOADED, false);

      //get all groups with settings
      int maxPageSize = GrouperUiConfig.retrieveConfig()
          .propertyValueInt("grouperUi.grouperLoader.maxGroupsShown", 200);
      Set<Group> groupsWithLoaderMetadata = new GroupFinder()
          .assignPrivileges(AccessPrivilege.VIEW_PRIVILEGES)
      ...
      if (GrouperUtil.length(groupsWithLoaderMetadata) > 0) {
        ...
        String loaderMetadataAttributeName = GrouperCheckConfig.loaderMetadataStemName()
            + ":" + GrouperLoader.LOADER_METADATA_VALUE_DEF;
        AttributeDefName attributeDefName = AttributeDefNameFinder
            .findByName(loaderMetadataAttributeName, false);
        ...
        guiLoaderManagedGroups
            .addAll(GuiLoaderManagedGroup.convertGroupIntoGuiLoaderManagedGroups(
                groupsWithLoaderMetadata, attributeAssignValueFinderResult));
   ...
   * @param response
   */
  public void scheduleLoaderGroup(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      try {
        ...
        // check sql first
        AttributeDefName grouperLoader = GrouperDAOFactory.getFactory()
            .getAttributeDefName()
            .findByNameSecure(GrouperConfig.retrieveConfig()
        ...
        // ok now check ldap
        if (!foundLoaderType) {
          AttributeDefName grouperLoaderLdapName = GrouperDAOFactory.getFactory()
              .getAttributeDefName()
              .findByNameSecure(LoaderLdapUtils.grouperLoaderLdapName(), false);

          if (grouperLoaderLdapName != null) {
            AttributeAssign assign = group.getAttributeDelegate()
                .retrieveAssignment("assign", grouperLoaderLdapName, true, false);
            if (assign != null) {
              foundLoaderType = true;
        ...
        //lets show an error message on the new screen  
        guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.error,
            TextContainer.retrieveFromRequest().getText().get("loaderGroupScheduleError")
                + "<br />"
                + e.getMessage()));
        return;
      }
      ...
      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
          TextContainer.retrieveFromRequest().getText()
              .get("loaderGroupScheduleSuccess")));
   ...
   * @param response
   */
  public void inheritedPrivilegesAssignedToThisGroupFromFolders(
      HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      {
        Set<RuleDefinition> groupRuleDefinitions = RuleFinder
            .findSubjectPrivilegeInheritRules(grouperSubject, true);
        for (RuleDefinition ruleDefinition : GrouperUtil.nonNull(groupRuleDefinitions)) {
          GuiRuleDefinition guiRuleDefinition = new GuiRuleDefinition(ruleDefinition);
          if (guiRuleDefinition.getOwnerGuiStem() != null) {
            guiRuleDefinitions.add(guiRuleDefinition);
   ...
   * @param response
   */
  public void convertGroupToRole(HttpServletRequest request,
      HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction
          .newScript("guiV2link('operation=UiV2GroupPermission.groupPermission&groupId="
              + group.getId() + "')"));

      //lets show a success message on the new screen
      guiResponseJs.addAction(GuiScreenAction.newMessage(GuiMessageType.success,
          TextContainer.retrieveFromRequest().getText()
              .get("groupConvertedToRoleSuccess")));
   ...
   * @param response
   */
  public void groupRoleAssignPermissionFilter(final HttpServletRequest request,
      HttpServletResponse response) {
    ...
    DojoComboLogic.logic(request, response, new DojoComboQueryLogicBase<Group>() {
      ...
      public Group lookup(HttpServletRequest localRequest, GrouperSession grouperSession,
        ...
        Subject loggedInSubject = grouperSession.getSubject();
        GroupFinder groupFinder = new GroupFinder()
            .assignPrivileges(AccessPrivilege.ATTRIBUTE_UPDATE_PRIVILEGES)
            .assignSubject(loggedInSubject)
            .assignFindByUuidOrName(true).assignScope(query)
            .addTypeOfGroup(TypeOfGroup.role);
