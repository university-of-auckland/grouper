...
public abstract class Provisioner
  ...
  protected void provisionItem(ProvisioningWorkItem workItem) throws PspException {
    ...
    try {
      LOG.debug("================workitem groupInfo {} ==============", workItem.getGroupInfo(this));
      ...
      LOG.debug("===============check workItemMightChangeGroupSelection================");
      if ( workItemMightChangeGroupSelection(workItem) ) { //todo this is new
        LOG.debug("===============processAnyChangesInGroupSelection==============");
      ...
      if ( workItem.getGroupInfo(this) != null &&
        ...
        LOG.debug("====================do full sync for group {}==============", workItem.groupName);
      ...
      if ( !workItem.hasBeenProcessed() ) {
        LOG.debug("========================Nothing to do (not a supported change) for {}=============", workItem.getChangelogEntry());
