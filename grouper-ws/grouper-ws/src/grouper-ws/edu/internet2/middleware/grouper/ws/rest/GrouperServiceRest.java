...
public class GrouperServiceRest {
  ...
  @ApiOperation(value = "Based on a group query, get the groups", notes = "", tags = {
      "rest", "groups" })
  ...
  public static WsFindGroupsResults findGroupsLite(GrouperVersion clientVersion,
    ...
    WsFindGroupsResults wsFindGroupsResults = new GrouperService(false).findGroupsLite(
        clientVersionString,
        wsRestFindGroupsLiteRequest.getQueryFilterType(),
        wsRestFindGroupsLiteRequest.getGroupName(),
        wsRestFindGroupsLiteRequest.getStemName(),
        wsRestFindGroupsLiteRequest.getStemNameScope(),
        wsRestFindGroupsLiteRequest.getGroupUuid(),
  ...
  public static WsGetMembersLiteResult getMembersLite(GrouperVersion clientVersion,
    ...
    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestGetMembersLiteRequest.getGroupName(), false,
        "groupName");

    // get the results
    WsGetMembersLiteResult wsGetMembersLiteResult = new GrouperService(false)
        .getMembersLite(clientVersionString,
            groupName, wsRestGetMembersLiteRequest.getGroupUuid(),
            wsRestGetMembersLiteRequest.getMemberFilter(),
            wsRestGetMembersLiteRequest.getActAsSubjectId(),
            wsRestGetMembersLiteRequest.getActAsSubjectSourceId(),
            wsRestGetMembersLiteRequest.getActAsSubjectIdentifier(),
            wsRestGetMembersLiteRequest.getFieldName(),
            wsRestGetMembersLiteRequest.getIncludeGroupDetail(),
            wsRestGetMembersLiteRequest.getRetrieveSubjectDetail(),
            wsRestGetMembersLiteRequest.getSubjectAttributeNames(),
            wsRestGetMembersLiteRequest.getParamName0(),
            wsRestGetMembersLiteRequest.getParamValue0(),
            wsRestGetMembersLiteRequest.getParamName1(),
            wsRestGetMembersLiteRequest.getParamValue1(),
  ...
  public static WsAddMemberLiteResult addMemberLite(GrouperVersion clientVersion,
    ...
    // make sure not null
    wsRestAddMemberLiteRequest = wsRestAddMemberLiteRequest == null
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        ...
        "clientVersion");
    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestAddMemberLiteRequest.getGroupName(), true,
        "groupName");
    subjectId = GrouperServiceUtils.pickOne(subjectId,
        wsRestAddMemberLiteRequest.getSubjectId(), false,
        "subjectId");
    sourceId = GrouperServiceUtils.pickOne(sourceId,
        wsRestAddMemberLiteRequest.getSubjectSourceId(), true,
        "sourceId");
    ...
    WsAddMemberLiteResult wsAddMemberLiteResult = new GrouperService(false).addMemberLite(
        ...
        wsRestAddMemberLiteRequest.getSubjectIdentifier(),
        wsRestAddMemberLiteRequest.getActAsSubjectId(),
        wsRestAddMemberLiteRequest.getActAsSubjectSourceId(),
        wsRestAddMemberLiteRequest.getActAsSubjectIdentifier(),
        wsRestAddMemberLiteRequest.getFieldName(),
        wsRestAddMemberLiteRequest.getIncludeGroupDetail(),
        wsRestAddMemberLiteRequest.getIncludeSubjectDetail(),
        wsRestAddMemberLiteRequest.getSubjectAttributeNames(),
        wsRestAddMemberLiteRequest.getParamName0(),
        wsRestAddMemberLiteRequest.getParamValue0(),
        wsRestAddMemberLiteRequest.getParamName1(),
        wsRestAddMemberLiteRequest.getParamValue1(),
  ...
  public static WsAddMemberResults addMember(GrouperVersion clientVersion,
    ...
    groupName = GrouperServiceUtils.pickOne(groupName, wsGroupLookup.getGroupName(), true,
        "groupName");
    wsGroupLookup.setGroupName(groupName);

    // get the results
    WsAddMemberResults wsAddMemberResults = new GrouperService(false).addMember(
        clientVersionString, wsGroupLookup,
        wsRestAddMembersRequest.getSubjectLookups(),
        wsRestAddMembersRequest.getReplaceAllExisting(),
        wsRestAddMembersRequest.getActAsSubjectLookup(),
        wsRestAddMembersRequest.getFieldName(),
        wsRestAddMembersRequest.getTxType(),
        wsRestAddMembersRequest.getIncludeGroupDetail(),
        wsRestAddMembersRequest.getIncludeSubjectDetail(),
  ...
  public static WsAssignGrouperPrivilegesResults assignGrouperPrivileges(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignGrouperPrivilegeRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    WsAssignGrouperPrivilegesResults wsAssignGrouperPrivilegesResults = new GrouperService(
        false)
            .assignGrouperPrivileges(clientVersionString,
                wsRestAssignGrouperPrivilegeRequest.getWsSubjectLookups(),
  ...
  public static WsDeleteMemberLiteResult deleteMemberLite(GrouperVersion clientVersion,
    ...
    // make sure not null
    wsRestDeleteMemberLiteRequest = wsRestDeleteMemberLiteRequest == null
        ? new WsRestDeleteMemberLiteRequest()
        : wsRestDeleteMemberLiteRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestDeleteMemberLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestDeleteMemberLiteRequest.getGroupName(), true,
        "groupName");
    subjectId = GrouperServiceUtils.pickOne(subjectId,
        wsRestDeleteMemberLiteRequest.getSubjectId(), false,
        "subjectId");
    sourceId = GrouperServiceUtils.pickOne(sourceId,
        wsRestDeleteMemberLiteRequest.getSubjectSourceId(), true,
        "sourceId");
    ...
    WsDeleteMemberLiteResult wsDeleteMemberLiteResult = new GrouperService(false)
        .deleteMemberLite(
            ...
            subjectId, sourceId,
            wsRestDeleteMemberLiteRequest.getSubjectIdentifier(),
            wsRestDeleteMemberLiteRequest.getActAsSubjectId(),
            wsRestDeleteMemberLiteRequest.getActAsSubjectSourceId(),
            wsRestDeleteMemberLiteRequest.getActAsSubjectIdentifier(),
            wsRestDeleteMemberLiteRequest.getFieldName(),
            wsRestDeleteMemberLiteRequest.getIncludeGroupDetail(),
            wsRestDeleteMemberLiteRequest.getIncludeSubjectDetail(),
            wsRestDeleteMemberLiteRequest.getSubjectAttributeNames(),
            wsRestDeleteMemberLiteRequest.getParamName0(),
            wsRestDeleteMemberLiteRequest.getParamValue0(),
            wsRestDeleteMemberLiteRequest.getParamName1(),
  ...
  public static WsHasMemberResults hasMember(GrouperVersion clientVersion,
    ...
    WsHasMemberResults wsHasMemberResults = new GrouperService(false).hasMember(
        clientVersionString, wsGroupLookup,
        wsRestHasMembersRequest.getSubjectLookups(),
        wsRestHasMembersRequest.getMemberFilter(),
        wsRestHasMembersRequest.getActAsSubjectLookup(),
        wsRestHasMembersRequest.getFieldName(),
        wsRestHasMembersRequest.getIncludeGroupDetail(),
        wsRestHasMembersRequest.getIncludeSubjectDetail(),
        wsRestHasMembersRequest.getSubjectAttributeNames(),
  ...
  public static WsGetMembersResults getMembers(GrouperVersion clientVersion,
    ...
    // cant be null
    GrouperUtil.assertion(wsRestGetMembersRequest != null,
        "Body of request must contain an instance of "
    ...
    WsGetMembersResults wsGetMembersResults = new GrouperService(false).getMembers(
        clientVersionString,
        wsRestGetMembersRequest.getWsGroupLookups(),
        wsRestGetMembersRequest.getMemberFilter(),
        wsRestGetMembersRequest.getActAsSubjectLookup(),
        wsRestGetMembersRequest.getFieldName(),
        wsRestGetMembersRequest.getIncludeGroupDetail(),
        wsRestGetMembersRequest.getIncludeSubjectDetail(),
        wsRestGetMembersRequest.getSubjectAttributeNames(),
  ...
  public static WsHasMemberLiteResult hasMemberLite(GrouperVersion clientVersion,
    ...
    // make sure not null
    wsRestHasMemberLiteRequest = wsRestHasMemberLiteRequest == null
        ? new WsRestHasMemberLiteRequest()
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        ...
        "clientVersion");
    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestHasMemberLiteRequest.getGroupName(), false,
        "groupName");
    subjectId = GrouperServiceUtils.pickOne(subjectId,
        wsRestHasMemberLiteRequest.getSubjectId(), false,
        "subjectId");
    sourceId = GrouperServiceUtils.pickOne(sourceId,
        wsRestHasMemberLiteRequest.getSubjectSourceId(), true,
        "sourceId");
    ...
    WsHasMemberLiteResult wsHasMemberLiteResult = new GrouperService(false).hasMemberLite(
        ...
        wsRestHasMemberLiteRequest.getSubjectIdentifier(),
        wsRestHasMemberLiteRequest.getMemberFilter(),
        ...
        wsRestHasMemberLiteRequest.getFieldName(),
        wsRestHasMemberLiteRequest.getIncludeGroupDetail(),
        wsRestHasMemberLiteRequest.getIncludeSubjectDetail(),
        wsRestHasMemberLiteRequest.getSubjectAttributeNames(),
        wsRestHasMemberLiteRequest.getParamName0(),
        wsRestHasMemberLiteRequest.getParamValue0(),
        wsRestHasMemberLiteRequest.getParamName1(),
        wsRestHasMemberLiteRequest.getParamValue1(),
  ...
  public static WsMemberChangeSubjectResults memberChangeSubject(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestMemberChangeSubjectRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsMemberChangeSubjectLiteResult memberChangeSubjectLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestMemberChangeSubjectLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    oldSubjectId = GrouperServiceUtils.pickOne(oldSubjectId,
        wsRestMemberChangeSubjectLiteRequest.getOldSubjectId(),
        false, "oldSubjectId");
    oldSubjectSourceId = GrouperServiceUtils.pickOne(oldSubjectSourceId,
        wsRestMemberChangeSubjectLiteRequest.getOldSubjectSourceId(), true,
        "oldSubjectSourceId");

    // get the results
    WsMemberChangeSubjectLiteResult wsMemberChangeSubjectLiteResult = new GrouperService(
        false)
            .memberChangeSubjectLite(clientVersionString, oldSubjectId,
                oldSubjectSourceId,
  ...
  public static WsGetGrouperPrivilegesLiteResult getGrouperPrivilegesLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestGetGrouperPrivilegesLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    WsGetGrouperPrivilegesLiteResult wsGetGrouperPrivilegesLiteResult = new GrouperService(
        false)
            .getGrouperPrivilegesLite(clientVersionString,
  ...
  public static WsAssignGrouperPrivilegesLiteResult assignGrouperPrivilegesLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignGrouperPrivilegesLiteRequest.getClientVersion()),
        false,
        "clientVersion");
   ...
   */
  @GET
  @Path("/subjects/{subjectId}/groups/get")
  @ApiOperation(value = ".", notes = "", tags = { "rest", "subjects" })
  public static WsGetGroupsResults getGroups(GrouperVersion clientVersion,
    ...
    WsGetGroupsResults wsGetGroupsResults = new GrouperService(false).getGroups(
        ...
        wsRestGetGroupsRequest.getIncludeSubjectDetail(),
        wsRestGetGroupsRequest.getSubjectAttributeNames(),
   ...
   */
  @GET
  @Path("/subjects/{subjectId}/groups/getLite")
  @ApiOperation(value = ".", notes = "", tags = { "rest", "subjects", "groups" })
  public static WsGetGroupsLiteResult getGroupsLite(GrouperVersion clientVersion,
      @PathParam("subjectId") String subjectId, String sourceId,
      WsRestGetGroupsLiteRequest wsRestGetGroupsLiteRequest) {

    // make sure not null
    wsRestGetGroupsLiteRequest = wsRestGetGroupsLiteRequest == null
        ? new WsRestGetGroupsLiteRequest()
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        ...
        "clientVersion");
    subjectId = GrouperServiceUtils.pickOne(subjectId,
        wsRestGetGroupsLiteRequest.getSubjectId(), false,
        "subjectId");
    sourceId = GrouperServiceUtils.pickOne(sourceId,
        wsRestGetGroupsLiteRequest.getSubjectSourceId(), true,
        "sourceId");
    ...
    WsGetGroupsLiteResult wsGetGroupsLiteResult = new GrouperService(false).getGroupsLite(
        ...
        wsRestGetGroupsLiteRequest.getMemberFilter(),
        wsRestGetGroupsLiteRequest.getActAsSubjectId(),
        ...
        wsRestGetGroupsLiteRequest.getSubjectAttributeNames(),
        wsRestGetGroupsLiteRequest.getParamName0(),
        wsRestGetGroupsLiteRequest.getParamValue0(),
        wsRestGetGroupsLiteRequest.getParamName1(),
        wsRestGetGroupsLiteRequest.getParamValue1(),
  ...
  @ApiOperation(value = "Based on a stem query, get the stems", notes = "", tags = {
      "rest", "stems" })
  ...
  public static WsFindStemsResults findStemsLite(GrouperVersion clientVersion,
    ...
    WsFindStemsResults wsFindStemsResults = new GrouperService(false).findStemsLite(
        clientVersionString,
        wsRestFindStemsLiteRequest.getStemQueryFilterType(),
        wsRestFindStemsLiteRequest.getStemName(),
        wsRestFindStemsLiteRequest.getParentStemName(),
        wsRestFindStemsLiteRequest.getParentStemNameScope(),
        wsRestFindStemsLiteRequest.getStemUuid(),
  ...
  public static WsStemSaveResults stemSave(GrouperVersion clientVersion,
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(wsRestStemSaveRequest.getClientVersion()), false,
        "clientVersion");

    // get the results
    WsStemSaveResults wsStemSaveResults = new GrouperService(false).stemSave(
        clientVersionString,
        wsRestStemSaveRequest.getWsStemToSaves(),
        wsRestStemSaveRequest.getActAsSubjectLookup(),
  ...
  public static WsStemSaveLiteResult stemSaveLite(GrouperVersion clientVersion,
    ...
    WsStemSaveLiteResult wsStemSaveLiteResult = new GrouperService(false).stemSaveLite(
        clientVersionString,
        wsRestStemSaveLiteRequest.getStemLookupUuid(), stemLookupName,
        wsRestStemSaveLiteRequest.getStemUuid(),
        wsRestStemSaveLiteRequest.getStemName(),
        wsRestStemSaveLiteRequest.getDisplayExtension(),
        wsRestStemSaveLiteRequest.getDescription(),
        wsRestStemSaveLiteRequest.getSaveMode(),
        wsRestStemSaveLiteRequest.getActAsSubjectId(),
        wsRestStemSaveLiteRequest.getActAsSubjectSourceId(),
        wsRestStemSaveLiteRequest.getActAsSubjectIdentifier(),
        wsRestStemSaveLiteRequest.getParamName0(),
        wsRestStemSaveLiteRequest.getParamValue0(),
        wsRestStemSaveLiteRequest.getParamName1(),
  ...
  public static WsStemDeleteResults stemDelete(GrouperVersion clientVersion,
    ...
    // cant be null
    GrouperUtil.assertion(wsRestStemDeleteRequest != null,
        "Body of request must contain an instance of "
    ...
    WsStemDeleteResults wsStemDeleteResults = new GrouperService(false).stemDelete(
        clientVersionString,
        wsRestStemDeleteRequest.getWsStemLookups(),
        wsRestStemDeleteRequest.getActAsSubjectLookup(),
  ...
  @ApiOperation(value = "Based on a stem name, delete the stem url.", notes = "", tags = {
      "rest", "stems" })
  public static WsStemDeleteLiteResult stemDeleteLite(GrouperVersion clientVersion,
    ...
    // make sure not null
    wsRestStemDeleteLiteRequest = wsRestStemDeleteLiteRequest == null
        ? new WsRestStemDeleteLiteRequest()
    ...
    stemName = GrouperServiceUtils.pickOne(stemName,
        wsRestStemDeleteLiteRequest.getStemName(), false, "stemName");

    // get the results
    WsStemDeleteLiteResult wsStemDeleteLiteResult = new GrouperService(false)
        .stemDeleteLite(clientVersionString,
            stemName, wsRestStemDeleteLiteRequest.getStemUuid(),
            wsRestStemDeleteLiteRequest.getActAsSubjectId(),
            wsRestStemDeleteLiteRequest.getActAsSubjectSourceId(),
            wsRestStemDeleteLiteRequest.getActAsSubjectIdentifier(),
            wsRestStemDeleteLiteRequest.getParamName0(),
            wsRestStemDeleteLiteRequest.getParamValue0(),
            wsRestStemDeleteLiteRequest.getParamName1(),
  ...
  public static WsGroupDeleteResults groupDelete(GrouperVersion clientVersion,
    ...
    WsGroupDeleteResults wsGroupDeleteResults = new GrouperService(false).groupDelete(
        ...
        wsRestGroupDeleteRequest.getActAsSubjectLookup(),
        wsRestGroupDeleteRequest.getTxType(),
        wsRestGroupDeleteRequest.getIncludeGroupDetail(),
  ...
  @ApiOperation(value = "Based on a group name, delete a group.", notes = "", tags = {
      "rest", "groups" })
  public static WsGroupDeleteLiteResult groupDeleteLite(GrouperVersion clientVersion,
    ...
    // make sure not null
    wsRestGroupDeleteLiteRequest = wsRestGroupDeleteLiteRequest == null
        ? new WsRestGroupDeleteLiteRequest()
        : wsRestGroupDeleteLiteRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(wsRestGroupDeleteLiteRequest.getClientVersion()),
        false,
        "clientVersion");

    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestGroupDeleteLiteRequest.getGroupName(), false,
        "groupName");

    // get the results
    WsGroupDeleteLiteResult wsGroupDeleteLiteResult = new GrouperService(false)
        .groupDeleteLite(clientVersionString,
            ...
            wsRestGroupDeleteLiteRequest.getParamName0(),
            wsRestGroupDeleteLiteRequest.getParamValue0(),
            wsRestGroupDeleteLiteRequest.getParamName1(),
  ...
  public static WsGroupSaveResults groupSave(GrouperVersion clientVersion,
    ...
    WsGroupSaveResults wsGroupSaveResults = new GrouperService(false).groupSave(
        clientVersionString,
        wsRestGroupSaveRequest.getWsGroupToSaves(),
  ...
  public static WsGroupSaveLiteResult groupSaveLite(GrouperVersion clientVersion,
    ...
    groupLookupName = GrouperServiceUtils.pickOne(groupLookupName,
        wsRestGroupSaveLiteRequest.getGroupLookupName(),
    ...
    WsGroupSaveLiteResult wsGroupSaveLiteResult = new GrouperService(false).groupSaveLite(
        ...
        wsRestGroupSaveLiteRequest.getGroupUuid(),
        wsRestGroupSaveLiteRequest.getGroupName(),
        wsRestGroupSaveLiteRequest.getDisplayExtension(),
        wsRestGroupSaveLiteRequest.getDescription(),
        wsRestGroupSaveLiteRequest.getSaveMode(),
        wsRestGroupSaveLiteRequest.getActAsSubjectId(),
        ...
        wsRestGroupSaveLiteRequest.getParamName0(),
        wsRestGroupSaveLiteRequest.getParamValue0(),
        wsRestGroupSaveLiteRequest.getParamName1(),
        wsRestGroupSaveLiteRequest.getParamValue1(),
        wsRestGroupSaveLiteRequest.getTypeOfGroup(),
  ...
  @POST
  @Path("groups/get")
  @ApiOperation(value = "Based on a group name get memberships.", notes = "", tags = {
      "rest", "groups" })
  public static WsGetMembershipsResults getMemberships(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestGetMembershipsRequest = wsRestGetMembershipsRequest == null
        ? new WsRestGetMembershipsRequest()
    ...
    WsGetMembershipsResults wsGetMembershipsResults = new GrouperService(false)
        .getMemberships(clientVersionString,
            groupLookupArray, subjectLookupArray,
            wsRestGetMembershipsRequest.getMemberFilter(),
            wsRestGetMembershipsRequest.getActAsSubjectLookup(),
            wsRestGetMembershipsRequest.getFieldName(),
            ...
            wsRestGetMembershipsRequest.getPageSize(),
            wsRestGetMembershipsRequest.getPageNumber(),
            wsRestGetMembershipsRequest.getSortString(),
  ...
  public static WsGetMembershipsResults getMembershipsLite(GrouperVersion clientVersion,
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestGetMembershipsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    groupName = GrouperServiceUtils.pickOne(groupName,
        wsRestGetMembershipsLiteRequest.getGroupName(), true,
        "groupName");
    subjectId = GrouperServiceUtils.pickOne(subjectId,
        wsRestGetMembershipsLiteRequest.getSubjectId(), true,
        "subjectId");
    sourceId = GrouperServiceUtils.pickOne(sourceId,
        wsRestGetMembershipsLiteRequest.getSubjectSourceId(), true,
        "sourceId");
    ...
    WsGetMembershipsResults wsGetMembershipsResults = new GrouperService(false)
        .getMembershipsLite(
            ...
            wsRestGetMembershipsLiteRequest.getParamName1(),
            wsRestGetMembershipsLiteRequest.getParamValue1(),
            ...
            wsRestGetMembershipsLiteRequest.getPageSize(),
            wsRestGetMembershipsLiteRequest.getPageNumber(),
            wsRestGetMembershipsLiteRequest.getSortString(),
  ...
  public static WsGetSubjectsResults getSubjects(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestGetSubjectsRequest = wsRestGetSubjectsRequest == null
        ? new WsRestGetSubjectsRequest()
  ...
  public static WsGetSubjectsResults getSubjectsLite(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestGetSubjectsLiteRequest = wsRestGetSubjectsLiteRequest == null
        ? new WsRestGetSubjectsLiteRequest()
        : wsRestGetSubjectsLiteRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(wsRestGetSubjectsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    if (!StringUtils.isBlank(sourceId)) {
      if (!StringUtils.isBlank(theSourceId)
        ...
        throw new WsInvalidQueryException(
            "sourceId in url '" + sourceId + "' is different than in XML submission '"
                + theSourceId + "'");
      }
  ...
  public static WsGetAttributeAssignmentsResults getAttributeAssignments(
    ...
    // cant be null
    wsRestGetAttributesRequest = wsRestGetAttributesRequest == null
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = new GrouperService(
        false)
            .getAttributeAssignments(clientVersionString,
                wsRestGetAttributesRequest.getAttributeAssignType(),
  ...
  public static WsGetAttributeAssignmentsResults getAttributeAssignmentsLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestGetAttributesLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefAssignActionResults assignAttributeDefActions(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignAttributeDefActionsRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsGetAttributeAssignActionsResults getAttributeAssignActions(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestGetAttributeAssignActionsRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsGetAttributeAssignActionsResults getAttributeAssignActionsLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestGetAttributeAssignActionsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAssignAttributesResults assignAttributes(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestAssignAttributesRequest = wsRestAssignAttributesRequest == null
        ? new WsRestAssignAttributesRequest()
        : wsRestAssignAttributesRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestAssignAttributesRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAssignAttributesLiteResults assignAttributesLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignAttributesLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    WsAssignAttributesLiteResults wsAssignAttributesLiteResults = new GrouperService(
        false).assignAttributesLite(
            clientVersionString,
            wsRestAssignAttributesLiteRequest.getAttributeAssignType(),
  ...
  public static WsGetPermissionAssignmentsResults getPermissionAssignments(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestGetPermissionAssignmentsRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsGetPermissionAssignmentsResults getPermissionAssignmentsLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestGetPermissionAssignmentsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAssignPermissionsResults assignPermissions(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestAssignPermissionsRequest = wsRestAssignPermissionsRequest == null
        ? new WsRestAssignPermissionsRequest()
        : wsRestAssignPermissionsRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestAssignPermissionsRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAssignPermissionsLiteResults assignPermissionsLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignPermissionsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefSaveResults attributeDefSave(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestAttributeDefSaveRequest = wsRestAttributeDefSaveRequest == null
        ? new WsRestAttributeDefSaveRequest()
        : wsRestAttributeDefSaveRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestAttributeDefSaveRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefSaveLiteResult attributeDefSaveLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefSaveLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefDeleteResults attributeDefDelete(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestAttributeDefDeleteRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    WsAttributeDefDeleteResults wsAttributeDefDeleteResults = new GrouperService(false)
        .attributeDefDelete(
            ...
            wsRestAttributeDefDeleteRequest.getTxType(),
  ...
  public static WsAttributeDefDeleteLiteResult attributeDefDeleteLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefDeleteLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsFindAttributeDefsResults findAttributeDefs(GrouperVersion clientVersion,
    ...
    // cant be null
    wsRestFindAttributeDefsRequest = wsRestFindAttributeDefsRequest == null
        ? new WsRestFindAttributeDefsRequest()
        : wsRestFindAttributeDefsRequest;

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestFindAttributeDefsRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsFindAttributeDefsResults findAttributeDefsLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestFindAttributeDefsLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAssignAttributeDefNameInheritanceResults assignAttributeDefNameInheritance(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignAttributeDefNameInheritanceRequest.getClientVersion()),
        false, "clientVersion");
  ...
  public static WsAssignAttributeDefNameInheritanceResults assignAttributeDefNameInheritanceLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignAttributeDefNameInheritanceLiteRequest.getClientVersion()),
        false, "clientVersion");
  ...
  public static WsAttributeDefNameDeleteResults attributeDefNameDelete(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefNameDeleteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefNameDeleteLiteResult attributeDefNameDeleteLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefNameDeleteLiteRequest.getClientVersion()),
        false,
        "clientVersion");

    attributeDefName = GrouperServiceUtils.pickOne(attributeDefName,
        wsRestAttributeDefNameDeleteLiteRequest.getAttributeDefNameName(), true,
        "attributeDefName");
  ...
  public static WsAttributeDefNameSaveResults attributeDefNameSave(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefNameSaveRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsAttributeDefNameSaveLiteResult attributeDefNameSaveLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAttributeDefNameSaveLiteRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsFindAttributeDefNamesResults findAttributeDefNames(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestFindAttributeDefNamesRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsFindAttributeDefNamesResults findAttributeDefNamesLite(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestFindAttributeDefNamesLiteRequest.getClientVersion()),
        false,
        "clientVersion");
    ...
    WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = new GrouperService(
        false)
            .findAttributeDefNamesLite(clientVersionString,
                wsRestFindAttributeDefNamesLiteRequest.getScope(),
  ...
  public static WsAssignAttributesBatchResults assignAttributesBatch(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestAssignAttributesBatchRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsMessageResults sendMessage(GrouperVersion clientVersion,
    ...
    WsMessageResults wsSendMessageResults = new GrouperService(false).sendMessage(
        clientVersionString,
        wsRestSendMessageRequest.getQueueType(),
  ...
  public static WsMessageResults receiveMessage(GrouperVersion clientVersion,
    ...
    wsRestReceiveMessageRequest = wsRestReceiveMessageRequest == null
        ? new WsRestReceiveMessageRequest()
  ...
  public static WsMessageAcknowledgeResults acknowledgeMessages(
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion
            .stringValueOrNull(wsRestMessageAcknowledgeRequest.getClientVersion()),
        false,
        "clientVersion");
  ...
  public static WsFindExternalSubjectsResults findExternalSubjects(
      GrouperVersion clientVersion,
      WsRestFindExternalSubjectsRequest wsRestFindExternalSubjectsRequest) {

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestFindExternalSubjectsRequest.getClientVersion()),
        false,
        "clientVersion");

    // get the results
    WsFindExternalSubjectsResults wsFindExternalSubjectsResults = new GrouperService(
        false).findExternalSubjects(
            clientVersionString,
            wsRestFindExternalSubjectsRequest.getWsExternalSubjectLookups(),
  ...
  @POST
  @Path("groups/saveLite")
  @ApiOperation(value = ".", notes = "", tags = { "rest", "groups", "externalSubjects" })
  public static WsExternalSubjectDeleteResults externalSubjectDelete(
      GrouperVersion clientVersion,
    ...
    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestExternalSubjectDeleteRequest.getClientVersion()),
        false,
        "clientVersion");

    // get the results
    WsExternalSubjectDeleteResults wsExternalSubjectDeleteResults = new GrouperService(
        false).externalSubjectDelete(
            clientVersionString,
            wsRestExternalSubjectDeleteRequest.getWsExternalSubjectLookups(),
            wsRestExternalSubjectDeleteRequest.getActAsSubjectLookup(),
            wsRestExternalSubjectDeleteRequest.getTxType(),
            wsRestExternalSubjectDeleteRequest.getParams());
  ...
  @ApiOperation(value = ".", notes = "", tags = { "rest", "externalSubjects" })
  public static WsExternalSubjectSaveResults externalSubjectSave(
      GrouperVersion clientVersion,
    ...
    GrouperUtil.assertion(wsRestExternalSubjectSaveRequest != null,
        "Body of request must contain an instance of "
            + WsRestExternalSubjectSaveRequest.class.getSimpleName()
            + " in xml, xhtml, json, etc");

    String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
        GrouperVersion.stringValueOrNull(
            wsRestExternalSubjectSaveRequest.getClientVersion()),
        false,
        "clientVersion");

    // get the results
    WsExternalSubjectSaveResults wsExternalSubjectSaveResults = new GrouperService(false)
        .externalSubjectSave(
            clientVersionString,
            wsRestExternalSubjectSaveRequest.getWsExternalSubjectToSaves(),
            wsRestExternalSubjectSaveRequest.getActAsSubjectLookup(),
            wsRestExternalSubjectSaveRequest.getTxType(),
