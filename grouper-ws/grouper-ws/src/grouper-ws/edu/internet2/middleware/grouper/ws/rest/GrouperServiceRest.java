...
/**
 * consolidated static list of of rest web services (only web service methods
 * here to have clean javadoc). the method name corresponds to the url and
 * request method. e.g. "GET /groups/a:b:c/members" will correspond to
 * groupMembersGet()
 */
@Api(value = "rest", tags = { "rest" })
@Path("/grouper-ws/servicesRest/v2_4_000")
@Configuration
@EnableSwagger2
public class GrouperServiceRest {
    ...
    @GET
    @Path("/version")
    @ApiOperation(value = "Gets version", response = String.class)
    @ApiResponses(value = { @ApiResponse(code = 200, message = "Version resource found"),
    ...
    // wsLiteObjectType=WsRestFindGroupsRequest&groupName=aGr&queryFilterType=FIND_BY_GROUP_NAME_APPROXIMATE&stemName=aStem
    @ApiOperation(value = "Based on a group query, get the groups", notes = "", tags = { "rest" })
    public static WsFindGroupsResults findGroups(GrouperVersion clientVersion,
        ...
        // get the results
        WsFindGroupsResults wsFindGroupsResults = new GrouperService(false).findGroups(clientVersionString,
                wsRestFindGroupsRequest.getWsQueryFilter(), wsRestFindGroupsRequest.getActAsSubjectLookup(),
                wsRestFindGroupsRequest.getIncludeGroupDetail(), wsRestFindGroupsRequest.getParams(),
    ...
    public static WsFindGroupsResults findGroupsLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindGroupsLiteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsFindGroupsResults wsFindGroupsResults = new GrouperService(false).findGroupsLite(clientVersionString,
                wsRestFindGroupsLiteRequest.getQueryFilterType(), wsRestFindGroupsLiteRequest.getGroupName(),
                wsRestFindGroupsLiteRequest.getStemName(), wsRestFindGroupsLiteRequest.getStemNameScope(),
                wsRestFindGroupsLiteRequest.getGroupUuid(), wsRestFindGroupsLiteRequest.getGroupAttributeName(),
                wsRestFindGroupsLiteRequest.getGroupAttributeValue(), wsRestFindGroupsLiteRequest.getGroupTypeName(),
                wsRestFindGroupsLiteRequest.getActAsSubjectId(), wsRestFindGroupsLiteRequest.getActAsSubjectSourceId(),
                wsRestFindGroupsLiteRequest.getActAsSubjectIdentifier(),
                wsRestFindGroupsLiteRequest.getIncludeGroupDetail(), wsRestFindGroupsLiteRequest.getParamName0(),
                wsRestFindGroupsLiteRequest.getParamValue0(), wsRestFindGroupsLiteRequest.getParamName1(),
                wsRestFindGroupsLiteRequest.getParamValue1(), wsRestFindGroupsLiteRequest.getPageSize(),
                wsRestFindGroupsLiteRequest.getPageNumber(), wsRestFindGroupsLiteRequest.getSortString(),
                wsRestFindGroupsLiteRequest.getAscending(), wsRestFindGroupsLiteRequest.getTypeOfGroups());
     ...
     * 
     * @param clientVersion               version of client, e.g. v1_3_000
     * @param groupName                   is the name of the group including stems,
     *                                    e.g. a:b:c
     * @param wsRestGetMembersLiteRequest is the request body converted to an object
     * @return the results
     */
    @POST
    @Path("groups/{groupName}/members/getLite")
    ...
    @ApiOperation(value = "Based on a group name, get the members", notes = "", tags = { "rest" })
    public static WsGetMembersLiteResult getMembersLite(GrouperVersion clientVersion,
            @PathParam(value = "groupName") String groupName, WsRestGetMembersLiteRequest wsRestGetMembersLiteRequest) {
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetMembersLiteRequest.getClientVersion()), false,
                "clientVersion");
        groupName = GrouperServiceUtils.pickOne(groupName, wsRestGetMembersLiteRequest.getGroupName(), false,
                "groupName");

        // get the results
        WsGetMembersLiteResult wsGetMembersLiteResult = new GrouperService(false).getMembersLite(clientVersionString,
                groupName, wsRestGetMembersLiteRequest.getGroupUuid(), wsRestGetMembersLiteRequest.getMemberFilter(),
                wsRestGetMembersLiteRequest.getActAsSubjectId(), wsRestGetMembersLiteRequest.getActAsSubjectSourceId(),
                wsRestGetMembersLiteRequest.getActAsSubjectIdentifier(), wsRestGetMembersLiteRequest.getFieldName(),
                wsRestGetMembersLiteRequest.getIncludeGroupDetail(),
                wsRestGetMembersLiteRequest.getRetrieveSubjectDetail(),
                wsRestGetMembersLiteRequest.getSubjectAttributeNames(), wsRestGetMembersLiteRequest.getParamName0(),
                wsRestGetMembersLiteRequest.getParamValue0(), wsRestGetMembersLiteRequest.getParamName1(),
                wsRestGetMembersLiteRequest.getParamValue1(), wsRestGetMembersLiteRequest.getSourceIds(),
                wsRestGetMembersLiteRequest.getPointInTimeFrom(), wsRestGetMembersLiteRequest.getPointInTimeTo(),
                wsRestGetMembersLiteRequest.getPageSize(), wsRestGetMembersLiteRequest.getPageNumber(),
                wsRestGetMembersLiteRequest.getSortString(), wsRestGetMembersLiteRequest.getAscending());
     ...
     * @param groupName                  is the name of the group including stems,
     *                                   e.g. a:b:c
     * @param subjectId                  from url, e.g.
     *                                   /v1_3_000/groups/aStem:aGroup/members/123412345
     ...
     */
    @POST
    @Path("/groups/{groupName}/members/addLite")
    // POST /grouper-ws/servicesRest/v2_4_000/groups/aStem%3AaGroup/members
    // wsLiteObjectType=WsRestAddMemberLiteRequest&actAsSubjectId=GrouperSystem&groupName=aStem:aGroup&subjectId=10021368
    @ApiOperation(value = "Add member to a group (if already a direct member, ignore)", notes = "", tags = { "rest" })
    public static WsAddMemberLiteResult addMemberLite(GrouperVersion clientVersion,
            @PathParam(value = "groupName") String groupName, @PathParam(value = "subjectId") String subjectId,
            @PathParam(value = "sourceId") String sourceId, WsRestAddMemberLiteRequest wsRestAddMemberLiteRequest) {
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAddMemberLiteRequest.getClientVersion()), false,
                "clientVersion");
        groupName = GrouperServiceUtils.pickOne(groupName, wsRestAddMemberLiteRequest.getGroupName(), true,
                "groupName");
        subjectId = GrouperServiceUtils.pickOne(subjectId, wsRestAddMemberLiteRequest.getSubjectId(), false,
                "subjectId");
        sourceId = GrouperServiceUtils.pickOne(sourceId, wsRestAddMemberLiteRequest.getSubjectSourceId(), true,
                "sourceId");

        // get the results
        WsAddMemberLiteResult wsAddMemberLiteResult = new GrouperService(false).addMemberLite(clientVersionString,
                groupName, wsRestAddMemberLiteRequest.getGroupUuid(), subjectId, sourceId,
                wsRestAddMemberLiteRequest.getSubjectIdentifier(), wsRestAddMemberLiteRequest.getActAsSubjectId(),
                wsRestAddMemberLiteRequest.getActAsSubjectSourceId(),
                wsRestAddMemberLiteRequest.getActAsSubjectIdentifier(), wsRestAddMemberLiteRequest.getFieldName(),
                wsRestAddMemberLiteRequest.getIncludeGroupDetail(),
                wsRestAddMemberLiteRequest.getIncludeSubjectDetail(),
                wsRestAddMemberLiteRequest.getSubjectAttributeNames(), wsRestAddMemberLiteRequest.getParamName0(),
                wsRestAddMemberLiteRequest.getParamValue0(), wsRestAddMemberLiteRequest.getParamName1(),
                wsRestAddMemberLiteRequest.getParamValue1(), wsRestAddMemberLiteRequest.getDisabledTime(),
     ...
     * 
     * @param clientVersion           version of client, e.g. v1_3_000
     * @param groupName               is the name of the group including stems, e.g.
     *                                a:b:c
    ...
    public static WsAddMemberResults addMember(GrouperVersion clientVersion, @PathParam("groupName") String groupName,
        ...
        groupName = GrouperServiceUtils.pickOne(groupName, wsGroupLookup.getGroupName(), true, "groupName");
        wsGroupLookup.setGroupName(groupName);

        // get the results
        WsAddMemberResults wsAddMemberResults = new GrouperService(false).addMember(clientVersionString, wsGroupLookup,
                wsRestAddMembersRequest.getSubjectLookups(), wsRestAddMembersRequest.getReplaceAllExisting(),
                wsRestAddMembersRequest.getActAsSubjectLookup(), wsRestAddMembersRequest.getFieldName(),
                wsRestAddMembersRequest.getTxType(), wsRestAddMembersRequest.getIncludeGroupDetail(),
                wsRestAddMembersRequest.getIncludeSubjectDetail(), wsRestAddMembersRequest.getSubjectAttributeNames(),
                wsRestAddMembersRequest.getParams(), wsRestAddMembersRequest.getDisabledTime(),
                wsRestAddMembersRequest.getEnabledTime(), wsRestAddMembersRequest.getAddExternalSubjectIfNotFound());
     ...
     * 
     * @param clientVersion                       version of client, e.g. v1_3_000
     * @param groupName                           is the name of the group including
     *                                            stems, e.g. a:b:c
     * @param wsRestAssignGrouperPrivilegeRequest is the request body converted to
     *                                            an object
     * @return the result
     */
    @POST
    ...
    public static WsAssignGrouperPrivilegesResults assignGrouperPrivileges(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignGrouperPrivilegeRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsAssignGrouperPrivilegesResults wsAssignGrouperPrivilegesResults = new GrouperService(false)
                .assignGrouperPrivileges(clientVersionString, wsRestAssignGrouperPrivilegeRequest.getWsSubjectLookups(),
                        ...
                        wsRestAssignGrouperPrivilegeRequest.getActAsSubjectLookup(),
                        wsRestAssignGrouperPrivilegeRequest.getIncludeSubjectDetail(),
                        wsRestAssignGrouperPrivilegeRequest.getSubjectAttributeNames(),
                        wsRestAssignGrouperPrivilegeRequest.getIncludeGroupDetail(),
                        wsRestAssignGrouperPrivilegeRequest.getParams());
     ...
     * @param sourceId                      from url (optional) e.g.
     *                                      /v1_3_000/groups/aStem:aGroup/members/sourceId/someSource/subjectId/123412345
     * @param wsRestDeleteMemberLiteRequest is the request body converted to an
     *                                      object
     * @return the result
     */
    // POST
    // /grouper-ws/servicesRest/v2_4_000/groups/aStem%3AaGroup/members/sources/jdbc/subjectId/test.subject.0
    // wsLiteObjectType=WsRestDeleteMemberLiteRequest&actAsSubjectId=GrouperSystem
    @POST
    @Path("/groups/{groupName}/members/sources/{sourceId}/subjectId/{subjectId}")
    @ApiOperation(value = "Based on a group name, delete the member", notes = "", tags = { "rest" })
    public static WsDeleteMemberLiteResult deleteMemberLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestDeleteMemberLiteRequest.getClientVersion()), false,
                "clientVersion");
        groupName = GrouperServiceUtils.pickOne(groupName, wsRestDeleteMemberLiteRequest.getGroupName(), true,
                "groupName");
        subjectId = GrouperServiceUtils.pickOne(subjectId, wsRestDeleteMemberLiteRequest.getSubjectId(), false,
                "subjectId");
        sourceId = GrouperServiceUtils.pickOne(sourceId, wsRestDeleteMemberLiteRequest.getSubjectSourceId(), true,
                "sourceId");

        // get the results
        WsDeleteMemberLiteResult wsDeleteMemberLiteResult = new GrouperService(false).deleteMemberLite(
                clientVersionString, groupName, wsRestDeleteMemberLiteRequest.getGroupUuid(), subjectId, sourceId,
                ...
                wsRestDeleteMemberLiteRequest.getActAsSubjectIdentifier(), wsRestDeleteMemberLiteRequest.getFieldName(),
                wsRestDeleteMemberLiteRequest.getIncludeGroupDetail(),
                wsRestDeleteMemberLiteRequest.getIncludeSubjectDetail(),
                wsRestDeleteMemberLiteRequest.getSubjectAttributeNames(), wsRestDeleteMemberLiteRequest.getParamName0(),
                wsRestDeleteMemberLiteRequest.getParamValue0(), wsRestDeleteMemberLiteRequest.getParamName1(),
                wsRestDeleteMemberLiteRequest.getParamValue1());
    ...
    public static WsDeleteMemberResults deleteMember(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestDeleteMembersRequest.getClientVersion()), false,
                "clientVersion");
        ...
        // get the results
        WsDeleteMemberResults wsDeleteMemberResults = new GrouperService(false).deleteMember(clientVersionString,
                wsGroupLookup, wsRestDeleteMembersRequest.getSubjectLookups(),
                wsRestDeleteMembersRequest.getActAsSubjectLookup(), wsRestDeleteMembersRequest.getFieldName(),
                wsRestDeleteMembersRequest.getTxType(), wsRestDeleteMembersRequest.getIncludeGroupDetail(),
                wsRestDeleteMembersRequest.getIncludeSubjectDetail(),
                wsRestDeleteMembersRequest.getSubjectAttributeNames(), wsRestDeleteMembersRequest.getParams());
    ...
    public static WsHasMemberResults hasMember(GrouperVersion clientVersion, @PathParam("groupName") String groupName,
        ...
        // get the results
        WsHasMemberResults wsHasMemberResults = new GrouperService(false).hasMember(clientVersionString, wsGroupLookup,
                wsRestHasMembersRequest.getSubjectLookups(), wsRestHasMembersRequest.getMemberFilter(),
                wsRestHasMembersRequest.getActAsSubjectLookup(), wsRestHasMembersRequest.getFieldName(),
                wsRestHasMembersRequest.getIncludeGroupDetail(), wsRestHasMembersRequest.getIncludeSubjectDetail(),
                wsRestHasMembersRequest.getSubjectAttributeNames(), wsRestHasMembersRequest.getParams(),
                wsRestHasMembersRequest.getPointInTimeFrom(), wsRestHasMembersRequest.getPointInTimeTo());
    ...
    public static WsGetMembersResults getMembers(GrouperVersion clientVersion,
        ...
        // get the results
        WsGetMembersResults wsGetMembersResults = new GrouperService(false).getMembers(clientVersionString,
                wsRestGetMembersRequest.getWsGroupLookups(), wsRestGetMembersRequest.getMemberFilter(),
                wsRestGetMembersRequest.getActAsSubjectLookup(), wsRestGetMembersRequest.getFieldName(),
                wsRestGetMembersRequest.getIncludeGroupDetail(), wsRestGetMembersRequest.getIncludeSubjectDetail(),
                wsRestGetMembersRequest.getSubjectAttributeNames(), wsRestGetMembersRequest.getParams(),
                wsRestGetMembersRequest.getSourceIds(), wsRestGetMembersRequest.getPointInTimeFrom(),
    ...
    public static WsHasMemberLiteResult hasMemberLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestHasMemberLiteRequest.getClientVersion()), false,
                "clientVersion");
        groupName = GrouperServiceUtils.pickOne(groupName, wsRestHasMemberLiteRequest.getGroupName(), false,
                "groupName");
        subjectId = GrouperServiceUtils.pickOne(subjectId, wsRestHasMemberLiteRequest.getSubjectId(), false,
                "subjectId");
        sourceId = GrouperServiceUtils.pickOne(sourceId, wsRestHasMemberLiteRequest.getSubjectSourceId(), true,
                "sourceId");

        // get the results
        WsHasMemberLiteResult wsHasMemberLiteResult = new GrouperService(false).hasMemberLite(clientVersionString,
                groupName, wsRestHasMemberLiteRequest.getGroupUuid(), subjectId, sourceId,
                wsRestHasMemberLiteRequest.getSubjectIdentifier(), wsRestHasMemberLiteRequest.getMemberFilter(),
                wsRestHasMemberLiteRequest.getActAsSubjectId(), wsRestHasMemberLiteRequest.getActAsSubjectSourceId(),
                wsRestHasMemberLiteRequest.getActAsSubjectIdentifier(), wsRestHasMemberLiteRequest.getFieldName(),
                wsRestHasMemberLiteRequest.getIncludeGroupDetail(),
                wsRestHasMemberLiteRequest.getIncludeSubjectDetail(),
                wsRestHasMemberLiteRequest.getSubjectAttributeNames(), wsRestHasMemberLiteRequest.getParamName0(),
                wsRestHasMemberLiteRequest.getParamValue0(), wsRestHasMemberLiteRequest.getParamName1(),
                wsRestHasMemberLiteRequest.getParamValue1(), wsRestHasMemberLiteRequest.getPointInTimeFrom(),
     ...
     * @param wsRestMemberChangeSubjectRequest is the request body converted to an
     *                                         object
     * @return the result
     */
    // ****
    public static WsMemberChangeSubjectResults memberChangeSubject(GrouperVersion clientVersion,
        ...
        // cant be null
        GrouperUtil.assertion(wsRestMemberChangeSubjectRequest != null, "Body of request must contain an instance of "
                + WsRestDeleteMemberRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestMemberChangeSubjectRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsMemberChangeSubjectResults wsMemberChangeSubjectResults = new GrouperService(false).memberChangeSubject(
                ...
                wsRestMemberChangeSubjectRequest.getActAsSubjectLookup(), wsRestMemberChangeSubjectRequest.getTxType(),
                wsRestMemberChangeSubjectRequest.getIncludeSubjectDetail(),
                wsRestMemberChangeSubjectRequest.getSubjectAttributeNames(),
                wsRestMemberChangeSubjectRequest.getParams());
     ...
     * 
     * @param clientVersion                        version of client, e.g. v1_3_000
     * @param oldSubjectId                         from url, e.g.
     *                                             /v1_3_000/members/subjectId/123412345
     * @param oldSubjectSourceId                   from url (optional) e.g.
     *                                             /v1_3_000/members/sourceId/someSource/subjectId/123412345/sourceId/12342
     * @param wsRestMemberChangeSubjectLiteRequest is the request body converted to
     *                                             an object
     * @return the result
     */
    // ****
    public static WsMemberChangeSubjectLiteResult memberChangeSubjectLite(GrouperVersion clientVersion,
        ...
        // make sure not null
        wsRestMemberChangeSubjectLiteRequest = wsRestMemberChangeSubjectLiteRequest == null
                ? new WsRestMemberChangeSubjectLiteRequest()
                : wsRestMemberChangeSubjectLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestMemberChangeSubjectLiteRequest.getClientVersion()), false,
                "clientVersion");
        oldSubjectId = GrouperServiceUtils.pickOne(oldSubjectId, wsRestMemberChangeSubjectLiteRequest.getOldSubjectId(),
                false, "oldSubjectId");
        oldSubjectSourceId = GrouperServiceUtils.pickOne(oldSubjectSourceId,
                wsRestMemberChangeSubjectLiteRequest.getOldSubjectSourceId(), true, "oldSubjectSourceId");

        // get the results
        WsMemberChangeSubjectLiteResult wsMemberChangeSubjectLiteResult = new GrouperService(false)
                .memberChangeSubjectLite(clientVersionString, oldSubjectId, oldSubjectSourceId,
                        ...
                        wsRestMemberChangeSubjectLiteRequest.getActAsSubjectId(),
                        ...
                        wsRestMemberChangeSubjectLiteRequest.getSubjectAttributeNames(),
                        wsRestMemberChangeSubjectLiteRequest.getParamName0(),
                        wsRestMemberChangeSubjectLiteRequest.getParamValue0(),
                        wsRestMemberChangeSubjectLiteRequest.getParamName1(),
                        wsRestMemberChangeSubjectLiteRequest.getParamValue1());
     ...
     * 
     * @param clientVersion                         version of client, e.g. v1_3_000
     * @param wsRestGetGrouperPrivilegesLiteRequest is the request body converted to
     *                                              an object
     * @return the result
     */
    public static WsGetGrouperPrivilegesLiteResult getGrouperPrivilegesLite(GrouperVersion clientVersion,
        ...
        // make sure not null
        wsRestGetGrouperPrivilegesLiteRequest = wsRestGetGrouperPrivilegesLiteRequest == null
                ? new WsRestGetGrouperPrivilegesLiteRequest()
                : wsRestGetGrouperPrivilegesLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetGrouperPrivilegesLiteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsGetGrouperPrivilegesLiteResult wsGetGrouperPrivilegesLiteResult = new GrouperService(false)
                .getGrouperPrivilegesLite(clientVersionString, wsRestGetGrouperPrivilegesLiteRequest.getSubjectId(),
     ...
     * </pre>
     * 
     * @param clientVersion                            version of client, e.g.
     *                                                 v1_3_000
     * @param wsRestAssignGrouperPrivilegesLiteRequest is the request body converted
     *                                                 to an object
     * @return the result
     */
    public static WsAssignGrouperPrivilegesLiteResult assignGrouperPrivilegesLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignGrouperPrivilegesLiteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsAssignGrouperPrivilegesLiteResult wsAssignGrouperPrivilegesLiteResult = new GrouperService(false)
                .assignGrouperPrivilegesLite(clientVersionString,
    ...
    public static WsGetGroupsResults getGroups(GrouperVersion clientVersion,
        ...
        // get the results
        WsGetGroupsResults wsGetGroupsResults = new GrouperService(false).getGroups(clientVersionString,
                subjectLookupArray, wsRestGetGroupsRequest.getMemberFilter(),
                wsRestGetGroupsRequest.getActAsSubjectLookup(), wsRestGetGroupsRequest.getIncludeGroupDetail(),
                wsRestGetGroupsRequest.getIncludeSubjectDetail(), wsRestGetGroupsRequest.getSubjectAttributeNames(),
                wsRestGetGroupsRequest.getParams(), wsRestGetGroupsRequest.getFieldName(),
                wsRestGetGroupsRequest.getScope(), wsRestGetGroupsRequest.getWsStemLookup(),
                wsRestGetGroupsRequest.getStemScope(), wsRestGetGroupsRequest.getEnabled(),
                wsRestGetGroupsRequest.getPageSize(), wsRestGetGroupsRequest.getPageNumber(),
                wsRestGetGroupsRequest.getSortString(), wsRestGetGroupsRequest.getAscending(),
     ...
     * @return the result
     */
    public static WsGetGroupsLiteResult getGroupsLite(GrouperVersion clientVersion, String subjectId, String sourceId,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetGroupsLiteRequest.getClientVersion()), false,
                "clientVersion");
        subjectId = GrouperServiceUtils.pickOne(subjectId, wsRestGetGroupsLiteRequest.getSubjectId(), false,
                "subjectId");
        sourceId = GrouperServiceUtils.pickOne(sourceId, wsRestGetGroupsLiteRequest.getSubjectSourceId(), true,
                "sourceId");

        // get the results
        WsGetGroupsLiteResult wsGetGroupsLiteResult = new GrouperService(false).getGroupsLite(clientVersionString,
                subjectId, sourceId, wsRestGetGroupsLiteRequest.getSubjectIdentifier(),
                wsRestGetGroupsLiteRequest.getMemberFilter(), wsRestGetGroupsLiteRequest.getActAsSubjectId(),
                wsRestGetGroupsLiteRequest.getActAsSubjectSourceId(),
                wsRestGetGroupsLiteRequest.getActAsSubjectIdentifier(),
                wsRestGetGroupsLiteRequest.getIncludeGroupDetail(),
                wsRestGetGroupsLiteRequest.getIncludeSubjectDetail(),
                wsRestGetGroupsLiteRequest.getSubjectAttributeNames(), wsRestGetGroupsLiteRequest.getParamName0(),
                wsRestGetGroupsLiteRequest.getParamValue0(), wsRestGetGroupsLiteRequest.getParamName1(),
                wsRestGetGroupsLiteRequest.getParamValue1(), wsRestGetGroupsLiteRequest.getFieldName(),
                ...
                wsRestGetGroupsLiteRequest.getAscending(), wsRestGetGroupsLiteRequest.getPointInTimeFrom(),
    ...
    @ApiOperation(value = "Based on a stem query, get the stems", notes = "", tags = { "rest" })
    public static WsFindStemsResults findStems(GrouperVersion clientVersion,
        ...
        // get the results
        WsFindStemsResults wsFindStemsResults = new GrouperService(false).findStems(clientVersionString,
                wsRestFindStemsRequest.getWsStemQueryFilter(), wsRestFindStemsRequest.getActAsSubjectLookup(),
                wsRestFindStemsRequest.getParams(), wsRestFindStemsRequest.getWsStemLookups());
    ...
    public static WsFindStemsResults findStemsLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindStemsLiteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsFindStemsResults wsFindStemsResults = new GrouperService(false).findStemsLite(clientVersionString,
                wsRestFindStemsLiteRequest.getStemQueryFilterType(), wsRestFindStemsLiteRequest.getStemName(),
                wsRestFindStemsLiteRequest.getParentStemName(), wsRestFindStemsLiteRequest.getParentStemNameScope(),
                wsRestFindStemsLiteRequest.getStemUuid(), wsRestFindStemsLiteRequest.getStemAttributeName(),
                wsRestFindStemsLiteRequest.getStemAttributeValue(), wsRestFindStemsLiteRequest.getActAsSubjectId(),
                wsRestFindStemsLiteRequest.getActAsSubjectSourceId(),
                wsRestFindStemsLiteRequest.getActAsSubjectIdentifier(), wsRestFindStemsLiteRequest.getParamName0(),
                wsRestFindStemsLiteRequest.getParamValue0(), wsRestFindStemsLiteRequest.getParamName1(),
    ...
    @POST
    @Path("stems/save")
    @ApiOperation(value = "Based on a submitted object of type WsRestStemSaveRequest, save stems", notes = "", tags = {
            "rest" })
    public static WsStemSaveResults stemSave(GrouperVersion clientVersion,
            WsRestStemSaveRequest wsRestStemSaveRequest) {

        // cant be null
        GrouperUtil.assertion(wsRestStemSaveRequest != null, "Body of request must contain an instance of "
        ...
        // get the results
        WsStemSaveResults wsStemSaveResults = new GrouperService(false).stemSave(clientVersionString,
                wsRestStemSaveRequest.getWsStemToSaves(), wsRestStemSaveRequest.getActAsSubjectLookup(),
                wsRestStemSaveRequest.getTxType(), wsRestStemSaveRequest.getParams());
     ...
     * 
     * @param clientVersion             version of client, e.g. v1_3_000
     * @param stemLookupName            is the name of the stem to lookup and save
     *                                  (old name if changing) including parent
     *                                  stems, e.g. a:b:c
    ...
    @POST
    @Path("stems/saveLite")
    @ApiOperation(value = "Based on a stem name and submitted object type WsRestStemSaveLiteRequest, save a stem.", notes = "", tags = {
            "rest", "stems" })
    public static WsStemSaveLiteResult stemSaveLite(GrouperVersion clientVersion, String stemLookupName,
            WsRestStemSaveLiteRequest wsRestStemSaveLiteRequest) {

        // cant be null
        GrouperUtil.assertion(wsRestStemSaveLiteRequest != null, "Body of request must contain an instance of "
                + WsRestStemSaveLiteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestStemSaveLiteRequest.getClientVersion()), false, "clientVersion");

        stemLookupName = GrouperServiceUtils.pickOne(stemLookupName, wsRestStemSaveLiteRequest.getStemLookupName(),
                false, "stemLookupName");

        // get the results
        WsStemSaveLiteResult wsStemSaveLiteResult = new GrouperService(false).stemSaveLite(clientVersionString,
                wsRestStemSaveLiteRequest.getStemLookupUuid(), stemLookupName, wsRestStemSaveLiteRequest.getStemUuid(),
                wsRestStemSaveLiteRequest.getStemName(), wsRestStemSaveLiteRequest.getDisplayExtension(),
                wsRestStemSaveLiteRequest.getDescription(), wsRestStemSaveLiteRequest.getSaveMode(),
                wsRestStemSaveLiteRequest.getActAsSubjectId(), wsRestStemSaveLiteRequest.getActAsSubjectSourceId(),
                wsRestStemSaveLiteRequest.getActAsSubjectIdentifier(), wsRestStemSaveLiteRequest.getParamName0(),
                wsRestStemSaveLiteRequest.getParamValue0(), wsRestStemSaveLiteRequest.getParamName1(),
                wsRestStemSaveLiteRequest.getParamValue1());
    ...
    @POST
    @Path("stems/delete")
    @ApiOperation(value = "Based on submitted object of type WsRestStemDeleteRequest, delete stems.", notes = "", tags = {
            "rest", "stems" })
    public static WsStemDeleteResults stemDelete(GrouperVersion clientVersion,
            WsRestStemDeleteRequest wsRestStemDeleteRequest) {

        // cant be null
        GrouperUtil.assertion(wsRestStemDeleteRequest != null, "Body of request must contain an instance of "
                + WsRestStemDeleteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestStemDeleteRequest.getClientVersion()), false, "clientVersion");

        // get the results
        WsStemDeleteResults wsStemDeleteResults = new GrouperService(false).stemDelete(clientVersionString,
                wsRestStemDeleteRequest.getWsStemLookups(), wsRestStemDeleteRequest.getActAsSubjectLookup(),
                wsRestStemDeleteRequest.getTxType(), wsRestStemDeleteRequest.getParams());
     ...
     * 
     * @param clientVersion               version of client, e.g. v1_3_000
     * @param stemName                    is the name of the stem to delete
     *                                    including parent stems, e.g. a:b:c
     * @param wsRestStemDeleteLiteRequest is the request body converted to an object
     * @return the result
     */
    @POST
    @Path("stems/deleteLite")
    @ApiOperation(value = "Based on a stem name, delete the stem url.", notes = "", tags = { "rest", "stems" })
    public static WsStemDeleteLiteResult stemDeleteLite(GrouperVersion clientVersion, String stemName,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestStemDeleteLiteRequest.getClientVersion()), false,
                "clientVersion");

        stemName = GrouperServiceUtils.pickOne(stemName, wsRestStemDeleteLiteRequest.getStemName(), false, "stemName");

        // get the results
        WsStemDeleteLiteResult wsStemDeleteLiteResult = new GrouperService(false).stemDeleteLite(clientVersionString,
                stemName, wsRestStemDeleteLiteRequest.getStemUuid(), wsRestStemDeleteLiteRequest.getActAsSubjectId(),
                wsRestStemDeleteLiteRequest.getActAsSubjectSourceId(),
                wsRestStemDeleteLiteRequest.getActAsSubjectIdentifier(), wsRestStemDeleteLiteRequest.getParamName0(),
                wsRestStemDeleteLiteRequest.getParamValue0(), wsRestStemDeleteLiteRequest.getParamName1(),
                wsRestStemDeleteLiteRequest.getParamValue1());
    ...
    @POST
    @Path("groups/delete")
    @ApiOperation(value = "Based on a submitted object of type WsRestGroupDeleteRequest, delete the groups.", notes = "", tags = {
            "rest", "groups" })
    public static WsGroupDeleteResults groupDelete(GrouperVersion clientVersion,
        ...
        // cant be null
        GrouperUtil.assertion(wsRestGroupDeleteRequest != null, "Body of request must contain an instance of "
                + WsRestGroupDeleteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGroupDeleteRequest.getClientVersion()), false, "clientVersion");

        // get the results
        WsGroupDeleteResults wsGroupDeleteResults = new GrouperService(false).groupDelete(clientVersionString,
                wsRestGroupDeleteRequest.getWsGroupLookups(), wsRestGroupDeleteRequest.getActAsSubjectLookup(),
                wsRestGroupDeleteRequest.getTxType(), wsRestGroupDeleteRequest.getIncludeGroupDetail(),
     ...
     * 
     * @param clientVersion                version of client, e.g. v1_3_000
     * @param groupName                    is the name of the group to delete
     *                                     including parent stems, e.g. a:b:c
     * @param subjectId                    from url, e.g.
     *                                     /v1_3_000/groups/aStem:aGroup/members/123412345
     * @param sourceId                     from url (optional) e.g.
     *                                     /v1_3_000/groups/aStem:aGroup/members/sourceId/someSource/subjectId/123412345
     * @param wsRestGroupDeleteLiteRequest is the request body converted to an
     *                                     object
     * @return the result
     */
    @POST
    @Path("groups/deleteLite")
    @ApiOperation(value = "Based on a group name, delete a group.", notes = "", tags = { "rest", "groups" })
    public static WsGroupDeleteLiteResult groupDeleteLite(GrouperVersion clientVersion, String groupName,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGroupDeleteLiteRequest.getClientVersion()), false,
                "clientVersion");

        groupName = GrouperServiceUtils.pickOne(groupName, wsRestGroupDeleteLiteRequest.getGroupName(), false,
                "groupName");

        // get the results
        WsGroupDeleteLiteResult wsGroupDeleteLiteResult = new GrouperService(false).groupDeleteLite(clientVersionString,
                groupName, wsRestGroupDeleteLiteRequest.getGroupUuid(),
                wsRestGroupDeleteLiteRequest.getActAsSubjectId(),
                wsRestGroupDeleteLiteRequest.getActAsSubjectSourceId(),
                wsRestGroupDeleteLiteRequest.getActAsSubjectIdentifier(),
                wsRestGroupDeleteLiteRequest.getIncludeGroupDetail(), wsRestGroupDeleteLiteRequest.getParamName0(),
                wsRestGroupDeleteLiteRequest.getParamValue0(), wsRestGroupDeleteLiteRequest.getParamName1(),
    ...
    @POST
    @Path("groups/save")
    @ApiOperation(value = "Based on a submitted object of type WsRestGroupSaveRequest, save groups.", notes = "", tags = {
            "rest", "groups" })
    public static WsGroupSaveResults groupSave(GrouperVersion clientVersion,
            WsRestGroupSaveRequest wsRestGroupSaveRequest) {

        // cant be null
        GrouperUtil.assertion(wsRestGroupSaveRequest != null, "Body of request must contain an instance of "
        ...
        // get the results
        WsGroupSaveResults wsGroupSaveResults = new GrouperService(false).groupSave(clientVersionString,
                wsRestGroupSaveRequest.getWsGroupToSaves(), wsRestGroupSaveRequest.getActAsSubjectLookup(),
                wsRestGroupSaveRequest.getTxType(), wsRestGroupSaveRequest.getIncludeGroupDetail(),
     ...
     * 
     * @param clientVersion              version of client, e.g. v1_3_000
     * @param groupLookupName            is the name of the group to lookup and save
     *                                   (old name if changing) including parent
     *                                   groups, e.g. a:b:c
     ...
     */
    @POST
    @Path("groups/saveLite")
    @ApiOperation(value = "Based on a group name and submitted object of type WsRestGroupSaveLieRequest, save a group.", notes = "", tags = {
            "rest", "groups" })
    public static WsGroupSaveLiteResult groupSaveLite(GrouperVersion clientVersion, String groupLookupName,
            WsRestGroupSaveLiteRequest wsRestGroupSaveLiteRequest) {

        // cant be null
        GrouperUtil.assertion(wsRestGroupSaveLiteRequest != null, "Body of request must contain an instance of "
                + WsRestGroupSaveLiteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGroupSaveLiteRequest.getClientVersion()), false,
                "clientVersion");

        groupLookupName = GrouperServiceUtils.pickOne(groupLookupName, wsRestGroupSaveLiteRequest.getGroupLookupName(),
                false, "groupLookupName");

        // get the results
        WsGroupSaveLiteResult wsGroupSaveLiteResult = new GrouperService(false).groupSaveLite(clientVersionString,
                wsRestGroupSaveLiteRequest.getGroupLookupUuid(), groupLookupName,
                wsRestGroupSaveLiteRequest.getGroupUuid(), wsRestGroupSaveLiteRequest.getGroupName(),
                wsRestGroupSaveLiteRequest.getDisplayExtension(), wsRestGroupSaveLiteRequest.getDescription(),
                wsRestGroupSaveLiteRequest.getSaveMode(), wsRestGroupSaveLiteRequest.getActAsSubjectId(),
                wsRestGroupSaveLiteRequest.getActAsSubjectSourceId(),
                wsRestGroupSaveLiteRequest.getActAsSubjectIdentifier(),
                wsRestGroupSaveLiteRequest.getIncludeGroupDetail(), wsRestGroupSaveLiteRequest.getParamName0(),
                wsRestGroupSaveLiteRequest.getParamValue0(), wsRestGroupSaveLiteRequest.getParamName1(),
                wsRestGroupSaveLiteRequest.getParamValue1(), wsRestGroupSaveLiteRequest.getTypeOfGroup(),
                wsRestGroupSaveLiteRequest.getAlternateName());
     ...
     * @param sourceId                    is the source id of the subject to search
     *                                    for (optional)
    ...
    @POST
    @Path("groups/get")
    @ApiOperation(value = "Based on a group name get memberships.", notes = "", tags = { "rest", "groups" })
    public static WsGetMembershipsResults getMemberships(GrouperVersion clientVersion, String groupName,
            String subjectId, String sourceId, WsRestGetMembershipsRequest wsRestGetMembershipsRequest) {
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetMembershipsRequest.getClientVersion()), false,
                "clientVersion");
        ...
        // get the results
        WsGetMembershipsResults wsGetMembershipsResults = new GrouperService(false).getMemberships(clientVersionString,
                groupLookupArray, subjectLookupArray, wsRestGetMembershipsRequest.getMemberFilter(),
                wsRestGetMembershipsRequest.getActAsSubjectLookup(), wsRestGetMembershipsRequest.getFieldName(),
                ...
                wsRestGetMembershipsRequest.getWsOwnerAttributeDefLookups(), wsRestGetMembershipsRequest.getFieldType(),
                wsRestGetMembershipsRequest.getServiceRole(), wsRestGetMembershipsRequest.getServiceLookup(),
                wsRestGetMembershipsRequest.getPageSize(), wsRestGetMembershipsRequest.getPageNumber(),
                wsRestGetMembershipsRequest.getSortString(), wsRestGetMembershipsRequest.getAscending(),
                wsRestGetMembershipsRequest.getPageNumberForMember(),
                wsRestGetMembershipsRequest.getPageNumberForMember(),
                wsRestGetMembershipsRequest.getSortStringForMember(),
     ...
     * @param groupName                       is the name of the group (optional)
     * @param subjectId                       is the subjectId (optional)
     * @param sourceId                        is the source id of the subject to
     *                                        search for (optional)
     * @param wsRestGetMembershipsLiteRequest is the request body converted to an
     *                                        object
     * @return the result
     */
    public static WsGetMembershipsResults getMembershipsLite(GrouperVersion clientVersion, String groupName,
            String subjectId, String sourceId, WsRestGetMembershipsLiteRequest wsRestGetMembershipsLiteRequest) {

        // make sure not null
        wsRestGetMembershipsLiteRequest = wsRestGetMembershipsLiteRequest == null
                ? new WsRestGetMembershipsLiteRequest()
                : wsRestGetMembershipsLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetMembershipsLiteRequest.getClientVersion()), false,
                "clientVersion");
        groupName = GrouperServiceUtils.pickOne(groupName, wsRestGetMembershipsLiteRequest.getGroupName(), true,
                "groupName");
        subjectId = GrouperServiceUtils.pickOne(subjectId, wsRestGetMembershipsLiteRequest.getSubjectId(), true,
                "subjectId");
        sourceId = GrouperServiceUtils.pickOne(sourceId, wsRestGetMembershipsLiteRequest.getSubjectSourceId(), true,
                "sourceId");

        // get the results
        WsGetMembershipsResults wsGetMembershipsResults = new GrouperService(false).getMembershipsLite(
                clientVersionString, groupName, wsRestGetMembershipsLiteRequest.getGroupUuid(), subjectId, sourceId,
                ...
                wsRestGetMembershipsLiteRequest.getActAsSubjectId(),
                ...
                wsRestGetMembershipsLiteRequest.getSubjectAttributeNames(),
                wsRestGetMembershipsLiteRequest.getIncludeGroupDetail(),
                wsRestGetMembershipsLiteRequest.getParamName0(), wsRestGetMembershipsLiteRequest.getParamValue0(),
                wsRestGetMembershipsLiteRequest.getParamName1(), wsRestGetMembershipsLiteRequest.getParamValue1(),
                wsRestGetMembershipsLiteRequest.getSourceIds(), wsRestGetMembershipsLiteRequest.getScope(),
                wsRestGetMembershipsLiteRequest.getStemName(), wsRestGetMembershipsLiteRequest.getStemUuid(),
                wsRestGetMembershipsLiteRequest.getStemScope(), wsRestGetMembershipsLiteRequest.getEnabled(),
                wsRestGetMembershipsLiteRequest.getMembershipIds(), wsRestGetMembershipsLiteRequest.getOwnerStemName(),
                ...
                wsRestGetMembershipsLiteRequest.getFieldType(), wsRestGetMembershipsLiteRequest.getServiceRole(),
                wsRestGetMembershipsLiteRequest.getServiceId(), wsRestGetMembershipsLiteRequest.getServiceName(),
                wsRestGetMembershipsLiteRequest.getPageSize(), wsRestGetMembershipsLiteRequest.getPageNumber(),
                wsRestGetMembershipsLiteRequest.getSortString(), wsRestGetMembershipsLiteRequest.getAscending(),
                wsRestGetMembershipsLiteRequest.getPageNumberForMember(),
                wsRestGetMembershipsLiteRequest.getPageNumberForMember(),
                wsRestGetMembershipsLiteRequest.getSortStringForMember(),
     ...
     * @param subjectId                is the subjectId (optional)
     * @param sourceId                 is the source id of the subject to search for
     *                                 (optional)
     * @param wsRestGetSubjectsRequest is the request body converted to an object
     * @return the result
     */
    public static WsGetSubjectsResults getSubjects(GrouperVersion clientVersion, String subjectId, String sourceId,
        ...
        // get the results
        WsGetSubjectsResults wsGetSubjectsResults = new GrouperService(false).getSubjects(clientVersionString,
                subjectLookupArray, wsRestGetSubjectsRequest.getSearchString(),
     ...
     * @param sourceId                     is the source id of the subject to search
     *                                     for (optional)
     * @param wsRestGetSubjectsLiteRequest is the request body converted to an
     *                                     object
     * @return the result
     */
    public static WsGetSubjectsResults getSubjectsLite(GrouperVersion clientVersion, String subjectId, String sourceId,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetSubjectsLiteRequest.getClientVersion()), false,
                "clientVersion");

        String theSubjectId = wsRestGetSubjectsLiteRequest.getSubjectId();

        if (!StringUtils.isBlank(subjectId)) {
            if (!StringUtils.isBlank(theSubjectId) && !StringUtils.equals(subjectId, theSubjectId)) {
        ...
        if (!StringUtils.isBlank(sourceId)) {
            if (!StringUtils.isBlank(theSourceId) && !StringUtils.equals(sourceId, theSourceId)) {
                throw new WsInvalidQueryException(
                        "sourceId in url '" + sourceId + "' is different than in XML submission '" + theSourceId + "'");
            }
            theSourceId = sourceId;
        }

        // get the results
        WsGetSubjectsResults wsGetSubjectsResults = new GrouperService(false).getSubjectsLite(clientVersionString,
                theSubjectId, theSourceId, wsRestGetSubjectsLiteRequest.getSubjectIdentifier(),
                wsRestGetSubjectsLiteRequest.getSearchString(), wsRestGetSubjectsLiteRequest.getIncludeSubjectDetail(),
    ...
    public static WsGetAttributeAssignmentsResults getAttributeAssignments(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetAttributesRequest.getClientVersion()), false,
                "clientVersion");

        WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = new GrouperService(false)
                .getAttributeAssignments(clientVersionString, wsRestGetAttributesRequest.getAttributeAssignType(),
                        ...
                        wsRestGetAttributesRequest.getEnabled(), wsRestGetAttributesRequest.getAttributeDefValueType(),
    ...
    public static WsGetAttributeAssignmentsResults getAttributeAssignmentsLite(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestGetAttributesLiteRequest = wsRestGetAttributesLiteRequest == null
                ? new WsRestGetAttributeAssignmentsLiteRequest()
                : wsRestGetAttributesLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetAttributesLiteRequest.getClientVersion()), false,
                "clientVersion");

        WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = new GrouperService(false)
                .getAttributeAssignmentsLite(clientVersionString,
                        wsRestGetAttributesLiteRequest.getAttributeAssignType(),
                        ...
                        wsRestGetAttributesLiteRequest.getParamName0(), wsRestGetAttributesLiteRequest.getParamValue0(),
                        wsRestGetAttributesLiteRequest.getParamName1(), wsRestGetAttributesLiteRequest.getParamValue1(),
    ...
    public static WsAttributeDefAssignActionResults assignAttributeDefActions(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAssignAttributeDefActionsRequest = wsRestAssignAttributeDefActionsRequest == null
                ? new WsRestAssignAttributeDefActionsRequest()
                : wsRestAssignAttributeDefActionsRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributeDefActionsRequest.getClientVersion()), false,
                "clientVersion");
    ...
    public static WsGetAttributeAssignActionsResults getAttributeAssignActions(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestGetAttributeAssignActionsRequest = wsRestGetAttributeAssignActionsRequest == null
                ? new WsRestGetAttributeAssignActionsRequest()
                : wsRestGetAttributeAssignActionsRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetAttributeAssignActionsRequest.getClientVersion()), false,
                "clientVersion");
    ...
    public static WsGetAttributeAssignActionsResults getAttributeAssignActionsLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetAttributeAssignActionsLiteRequest.getClientVersion()), false,
                "clientVersion");

        WsGetAttributeAssignActionsResults wsGetAttributeAssignActionsResults = new GrouperService(false)
                .getAttributeAssignActionsLite(clientVersionString,
    ...
    public static WsAssignAttributesResults assignAttributes(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributesRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAssignAttributesResults wsAssignAttributesResults = new GrouperService(false).assignAttributes(
                ...
                wsRestAssignAttributesRequest.getAttributeAssignOperation(), wsRestAssignAttributesRequest.getValues(),
                ...
                wsRestAssignAttributesRequest.getActions(), wsRestAssignAttributesRequest.getActAsSubjectLookup(),
    ...
    public static WsAssignAttributesLiteResults assignAttributesLite(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAssignAttributesLiteRequest = wsRestAssignAttributesLiteRequest == null
                ? new WsRestAssignAttributesLiteRequest()
                : wsRestAssignAttributesLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributesLiteRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAssignAttributesLiteResults wsAssignAttributesLiteResults = new GrouperService(false).assignAttributesLite(
                ...
                wsRestAssignAttributesLiteRequest.getValueId(), wsRestAssignAttributesLiteRequest.getValueSystem(),
                ...
                wsRestAssignAttributesLiteRequest.getAction(), wsRestAssignAttributesLiteRequest.getActAsSubjectId(),
                ...
                wsRestAssignAttributesLiteRequest.getParamName0(), wsRestAssignAttributesLiteRequest.getParamValue0(),
                wsRestAssignAttributesLiteRequest.getParamName1(), wsRestAssignAttributesLiteRequest.getParamValue1());
    ...
    public static WsGetPermissionAssignmentsResults getPermissionAssignments(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetPermissionAssignmentsRequest.getClientVersion()), false,
                "clientVersion");

        WsGetPermissionAssignmentsResults wsGetPermissionAssignmentsResults = new GrouperService(false)
                .getPermissionAssignments(clientVersionString,
    ...
    public static WsGetPermissionAssignmentsResults getPermissionAssignmentsLite(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestGetPermissionAssignmentsLiteRequest = wsRestGetPermissionAssignmentsLiteRequest == null
                ? new WsRestGetPermissionAssignmentsLiteRequest()
                : wsRestGetPermissionAssignmentsLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestGetPermissionAssignmentsLiteRequest.getClientVersion()), false,
                "clientVersion");

        WsGetPermissionAssignmentsResults wsGetPermissionAssignmentsResults = new GrouperService(false)
                .getPermissionAssignmentsLite(clientVersionString,
                        wsRestGetPermissionAssignmentsLiteRequest.getWsAttributeDefName(),
                        ...
                        wsRestGetPermissionAssignmentsLiteRequest.getIncludeAssignmentsOnAssignments(),
    ...
    public static WsAssignPermissionsResults assignPermissions(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignPermissionsRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAssignPermissionsResults wsAssignPermissionsResults = new GrouperService(false).assignPermissions(
                ...
                wsRestAssignPermissionsRequest.getRoleLookups(), wsRestAssignPermissionsRequest.getSubjectRoleLookups(),
                wsRestAssignPermissionsRequest.getActions(), wsRestAssignPermissionsRequest.getActAsSubjectLookup(),
                ...
                wsRestAssignPermissionsRequest.getActionsToReplace(), wsRestAssignPermissionsRequest.getDisallowed());
    ...
    public static WsAssignPermissionsLiteResults assignPermissionsLite(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAssignPermissionsLiteRequest = wsRestAssignPermissionsLiteRequest == null
                ? new WsRestAssignPermissionsLiteRequest()
                : wsRestAssignPermissionsLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignPermissionsLiteRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAssignPermissionsLiteResults wsAssignPermissionsLiteResults = new GrouperService(false).assignPermissionsLite(
                ...
                wsRestAssignPermissionsLiteRequest.getRoleName(), wsRestAssignPermissionsLiteRequest.getRoleId(),
                ...
                wsRestAssignPermissionsLiteRequest.getAction(), wsRestAssignPermissionsLiteRequest.getActAsSubjectId(),
                ...
                wsRestAssignPermissionsLiteRequest.getParamName0(), wsRestAssignPermissionsLiteRequest.getParamValue0(),
                wsRestAssignPermissionsLiteRequest.getParamName1(), wsRestAssignPermissionsLiteRequest.getParamValue1(),
    ...
    /**
     * save an AttributeDef or many (insert or update). Note, you cannot rename an
     * existing AttributeDef.
     * 
     * @param clientVersion                 is the version of the client. Must be in
     *                                      GrouperWsVersion, e.g. v1_3_000
    ...
    public static WsAttributeDefSaveResults attributeDefSave(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefSaveRequest.getClientVersion()), false,
                "clientVersion");

        WsAttributeDefSaveResults wsAttributeDefSaveResults = new GrouperService(false).attributeDefSave(
                clientVersionString, wsRestAttributeDefSaveRequest.getWsAttributeDefsToSave(),
                wsRestAttributeDefSaveRequest.getActAsSubjectLookup(), wsRestAttributeDefSaveRequest.getTxType(),
    ...
    /**
     * save an AttributeDef (insert or update). Note you cannot currently move an
     * existing AttributeDef.
     * 
     * @see {@link AttributeDefSave#save()}
     * @param clientVersion                     is the version of the client. Must
     *                                          be in GrouperWsVersion, e.g.
     *                                          v1_3_000
    ...
    public static WsAttributeDefSaveLiteResult attributeDefSaveLite(GrouperVersion clientVersion,
            String attributeDefLookupName, WsRestAttributeDefSaveLiteRequest wsRestAttributeDefSaveLiteRequest) {

        // cant be null
        wsRestAttributeDefSaveLiteRequest = wsRestAttributeDefSaveLiteRequest == null
                ? new WsRestAttributeDefSaveLiteRequest()
                : wsRestAttributeDefSaveLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefSaveLiteRequest.getClientVersion()), false,
                "clientVersion");

        attributeDefLookupName = GrouperServiceUtils.pickOne(attributeDefLookupName,
                wsRestAttributeDefSaveLiteRequest.getAttributeDefLookupName(), true, "attributeDefLookupName");

        WsAttributeDefSaveLiteResult wsAttributeDefSaveLiteResult = new GrouperService(false).attributeDefSaveLite(
                clientVersionString, wsRestAttributeDefSaveLiteRequest.getAttributeDefLookupUuid(),
                attributeDefLookupName, wsRestAttributeDefSaveLiteRequest.getUuidOfAttributeDef(),
                ...
                wsRestAttributeDefSaveLiteRequest.getMultiValued(), wsRestAttributeDefSaveLiteRequest.getValueType(),
                wsRestAttributeDefSaveLiteRequest.getDescription(), wsRestAttributeDefSaveLiteRequest.getSaveMode(),
                ...
                wsRestAttributeDefSaveLiteRequest.getParamName0(), wsRestAttributeDefSaveLiteRequest.getParamValue0(),
                wsRestAttributeDefSaveLiteRequest.getParamName1(), wsRestAttributeDefSaveLiteRequest.getParamValue1());
     ...
     * 
     * @param clientVersion                   version of client, e.g. v1_3_000
     * @param wsRestAttributeDefDeleteRequest is the request body converted to an
     *                                        object
     * @return the result
     */
    public static WsAttributeDefDeleteResults attributeDefDelete(GrouperVersion clientVersion,
        ...
        // cant be null
        GrouperUtil.assertion(wsRestAttributeDefDeleteRequest != null, "Body of request must contain an instance of "
                + WsRestAttributeDefDeleteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefDeleteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsAttributeDefDeleteResults wsAttributeDefDeleteResults = new GrouperService(false).attributeDefDelete(
                clientVersionString, wsRestAttributeDefDeleteRequest.getWsAttributeDefLookups(),
                wsRestAttributeDefDeleteRequest.getActAsSubjectLookup(), wsRestAttributeDefDeleteRequest.getTxType(),
                wsRestAttributeDefDeleteRequest.getParams());
    ...
    /**
     * @param clientVersion                       version of client, e.g. v1_3_000
     * @param wsRestAttributeDefDeleteLiteRequest is the request body converted to
     *                                            an object
     * @return the result
     */
    public static WsAttributeDefDeleteLiteResult attributeDefDeleteLite(GrouperVersion clientVersion,
        ...
        // make sure not null
        wsRestAttributeDefDeleteLiteRequest = wsRestAttributeDefDeleteLiteRequest == null
                ? new WsRestAttributeDefDeleteLiteRequest()
                : wsRestAttributeDefDeleteLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefDeleteLiteRequest.getClientVersion()), false,
                "clientVersion");

        // get the results
        WsAttributeDefDeleteLiteResult wsAttributeDefDeleteLiteResult = new GrouperService(false)
                .attributeDefDeleteLite(clientVersionString,
                        wsRestAttributeDefDeleteLiteRequest.getNameOfAttributeDef(),
                        ...
                        wsRestAttributeDefDeleteLiteRequest.getParamValue0(),
                        wsRestAttributeDefDeleteLiteRequest.getParamName1(),
    ...
    /**
     * find an attribute def or attribute defs. Each additional parameter sent will
     * narow the search, except the lookups will just lookup whatever is sent.
     * 
     * @param clientVersion                  is the version of the client. Must be
     *                                       in GrouperWsVersion, e.g. v1_3_000
    ...
    public static WsFindAttributeDefsResults findAttributeDefs(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindAttributeDefsRequest.getClientVersion()), false,
                "clientVersion");

        WsFindAttributeDefsResults wsFindAttributeDefsResults = new GrouperService(false).findAttributeDefs(
                ...
                wsRestFindAttributeDefsRequest.getPrivilegeName(), wsRestFindAttributeDefsRequest.getStemScope(),
                wsRestFindAttributeDefsRequest.getParentStemId(), wsRestFindAttributeDefsRequest.getFindByUuidOrName(),
                wsRestFindAttributeDefsRequest.getPageSize(), wsRestFindAttributeDefsRequest.getPageNumber(),
                wsRestFindAttributeDefsRequest.getSortString(), wsRestFindAttributeDefsRequest.getAscending(),
                wsRestFindAttributeDefsRequest.getActAsSubjectLookup(), wsRestFindAttributeDefsRequest.getParams());
    ...
    public static WsFindAttributeDefsResults findAttributeDefsLite(GrouperVersion clientVersion,
        ...
        wsRestFindAttributeDefsLiteRequest = wsRestFindAttributeDefsLiteRequest == null
                ? new WsRestFindAttributeDefsLiteRequest()
                : wsRestFindAttributeDefsLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindAttributeDefsLiteRequest.getClientVersion()), false,
                "clientVersion");

        WsFindAttributeDefsResults wsFindAttributeDefsResults = new GrouperService(false).findAttributeDefsLite(
                ...
                wsRestFindAttributeDefsLiteRequest.getStemScope(), wsRestFindAttributeDefsLiteRequest.getParentStemId(),
                wsRestFindAttributeDefsLiteRequest.getFindByUuidOrName(),
                wsRestFindAttributeDefsLiteRequest.getPageSize(), wsRestFindAttributeDefsLiteRequest.getPageNumber(),
                wsRestFindAttributeDefsLiteRequest.getSortString(), wsRestFindAttributeDefsLiteRequest.getAscending(),
                ...
                wsRestFindAttributeDefsLiteRequest.getParamName0(), wsRestFindAttributeDefsLiteRequest.getParamValue0(),
    ...
    public static WsAssignAttributeDefNameInheritanceResults assignAttributeDefNameInheritance(
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributeDefNameInheritanceRequest.getClientVersion()),
                false, "clientVersion");

        WsAssignAttributeDefNameInheritanceResults wsAssignAttributeDefNameInheritanceResults = new GrouperService(
                false).assignAttributeDefNameInheritance(clientVersionString,
                        wsRestAssignAttributeDefNameInheritanceRequest.getWsAttributeDefNameLookup(),
                        wsRestAssignAttributeDefNameInheritanceRequest.getRelatedWsAttributeDefNameLookups(),
     ...
     * assign or unassign attribute def name permission inheritance
     * 
     * @param clientVersion                                      is the version of
     *                                                           the client. Must be
     *                                                           in
     *                                                           GrouperWsVersion,
     *                                                           e.g. v1_3_000
    ...
    public static WsAssignAttributeDefNameInheritanceResults assignAttributeDefNameInheritanceLite(
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributeDefNameInheritanceLiteRequest.getClientVersion()),
                false, "clientVersion");

        WsAssignAttributeDefNameInheritanceResults wsAssignAttributeDefNameInheritanceResults = new GrouperService(
                false).assignAttributeDefNameInheritanceLite(clientVersionString,
                        wsRestAssignAttributeDefNameInheritanceLiteRequest.getAttributeDefNameUuid(),
                        wsRestAssignAttributeDefNameInheritanceLiteRequest.getAttributeDefNameName(),
                        wsRestAssignAttributeDefNameInheritanceLiteRequest.getRelatedAttributeDefNameUuid(),
                        wsRestAssignAttributeDefNameInheritanceLiteRequest.getRelatedAttributeDefNameName(),
    ...
    /**
     * delete an AttributeDefName or many. Note, you cannot rename an existing
     * AttributeDefName.
     * 
     * @param clientVersion                       is the version of the client. Must
     *                                            be in GrouperWsVersion, e.g.
    ...
    public static WsAttributeDefNameDeleteResults attributeDefNameDelete(GrouperVersion clientVersion,
        ...
        wsRestAttributeDefNameDeleteRequest = wsRestAttributeDefNameDeleteRequest == null
                ? new WsRestAttributeDefNameDeleteRequest()
                : wsRestAttributeDefNameDeleteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefNameDeleteRequest.getClientVersion()), false,
                "clientVersion");

        WsAttributeDefNameDeleteResults wsAttributeDefNameDeleteResults = new GrouperService(false)
                .attributeDefNameDelete(clientVersionString,
     ...
     * 
     * @param clientVersion                           is the version of the client.
     *                                                Must be in GrouperWsVersion,
     *                                                e.g. v1_3_000
    ...
    public static WsAttributeDefNameDeleteLiteResult attributeDefNameDeleteLite(GrouperVersion clientVersion,
            String attributeDefName, WsRestAttributeDefNameDeleteLiteRequest wsRestAttributeDefNameDeleteLiteRequest) {
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefNameDeleteLiteRequest.getClientVersion()), false,
                "clientVersion");

        attributeDefName = GrouperServiceUtils.pickOne(attributeDefName,
                wsRestAttributeDefNameDeleteLiteRequest.getAttributeDefNameName(), true, "attributeDefName");

        WsAttributeDefNameDeleteLiteResult wsAttributeDefNameDeleteLiteResult = new GrouperService(false)
                .attributeDefNameDeleteLite(clientVersionString,
                        wsRestAttributeDefNameDeleteLiteRequest.getAttributeDefNameUuid(), attributeDefName,
                        wsRestAttributeDefNameDeleteLiteRequest.getActAsSubjectId(),
    ...
    /**
     * save an AttributeDefName or many (insert or update). Note, you cannot rename
     * an existing AttributeDefName.
     * 
     * @param clientVersion                     is the version of the client. Must
     *                                          be in GrouperWsVersion, e.g.
     *                                          v1_3_000
    ...
    public static WsAttributeDefNameSaveResults attributeDefNameSave(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAttributeDefNameSaveRequest = wsRestAttributeDefNameSaveRequest == null
                ? new WsRestAttributeDefNameSaveRequest()
                : wsRestAttributeDefNameSaveRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefNameSaveRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAttributeDefNameSaveResults wsAttributeDefNameSaveResults = new GrouperService(false).attributeDefNameSave(
                ...
                wsRestAttributeDefNameSaveRequest.getTxType(), wsRestAttributeDefNameSaveRequest.getParams());
    ...
    /**
     * save an AttributeDefName (insert or update). Note you cannot currently move
     * an existing AttributeDefName.
     * 
    ...
    public static WsAttributeDefNameSaveLiteResult attributeDefNameSaveLite(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAttributeDefNameSaveLiteRequest = wsRestAttributeDefNameSaveLiteRequest == null
                ? new WsRestAttributeDefNameSaveLiteRequest()
                : wsRestAttributeDefNameSaveLiteRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAttributeDefNameSaveLiteRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsAttributeDefNameSaveLiteResult wsAttributeDefNameSaveLiteResult = new GrouperService(false)
                .attributeDefNameSaveLite(clientVersionString,
                        wsRestAttributeDefNameSaveLiteRequest.getAttributeDefNameLookupUuid(),
                        attributeDefNameLookupName, wsRestAttributeDefNameSaveLiteRequest.getAttributeDefLookupUuid(),
    ...
    /**
     * find an attribute def name or attribute def names. Each additional parameter
     * sent will narow the search, except the lookups will just lookup whatever is
     * sent.
     * 
     * @param clientVersion                      is the version of the client. Must
     *                                           be in GrouperWsVersion, e.g.
    ...
    public static WsFindAttributeDefNamesResults findAttributeDefNames(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestFindAttributeDefNamesRequest = wsRestFindAttributeDefNamesRequest == null
                ? new WsRestFindAttributeDefNamesRequest()
                : wsRestFindAttributeDefNamesRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindAttributeDefNamesRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = new GrouperService(false).findAttributeDefNames(
                ...
                wsRestFindAttributeDefNamesRequest.getPageSize(), wsRestFindAttributeDefNamesRequest.getPageNumber(),
                wsRestFindAttributeDefNamesRequest.getSortString(), wsRestFindAttributeDefNamesRequest.getAscending(),
                wsRestFindAttributeDefNamesRequest.getWsInheritanceSetRelation(),
                wsRestFindAttributeDefNamesRequest.getActAsSubjectLookup(),
                wsRestFindAttributeDefNamesRequest.getParams(), wsRestFindAttributeDefNamesRequest.getSubjectLookup(),
    ...
    public static WsFindAttributeDefNamesResults findAttributeDefNamesLite(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindAttributeDefNamesLiteRequest.getClientVersion()), false,
                "clientVersion");

        attributeDefNameName = GrouperServiceUtils.pickOne(attributeDefNameName,
                wsRestFindAttributeDefNamesLiteRequest.getAttributeDefNameName(), true, "attributeDefNameName");

        WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = new GrouperService(false)
                .findAttributeDefNamesLite(clientVersionString, wsRestFindAttributeDefNamesLiteRequest.getScope(),
                        ...
                        wsRestFindAttributeDefNamesLiteRequest.getAttributeDefNameUuid(), attributeDefNameName,
    ...
    public static WsAssignAttributesBatchResults assignAttributesBatch(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestAssignAttributesBatchRequest = wsRestAssignAttributesBatchRequest == null
                ? new WsRestAssignAttributesBatchRequest()
                : wsRestAssignAttributesBatchRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestAssignAttributesBatchRequest.getClientVersion()), false,
                "clientVersion");
    ...
    public static WsMessageResults sendMessage(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestSendMessageRequest = wsRestSendMessageRequest == null ? new WsRestSendMessageRequest()
                : wsRestSendMessageRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestSendMessageRequest.getClientVersion()), false, "clientVersion");

        WsMessageResults wsSendMessageResults = new GrouperService(false).sendMessage(clientVersionString,
                wsRestSendMessageRequest.getQueueType(), wsRestSendMessageRequest.getQueueOrTopicName(),
                wsRestSendMessageRequest.getMessageSystemName(), wsRestSendMessageRequest.getRoutingKey(),
                wsRestSendMessageRequest.isAutocreateObjects(), wsRestSendMessageRequest.getMessages(),
                wsRestSendMessageRequest.getActAsSubjectLookup(), wsRestSendMessageRequest.getParams());
    ...
    public static WsMessageResults receiveMessage(GrouperVersion clientVersion,
        ...
        // cant be null
        wsRestReceiveMessageRequest = wsRestReceiveMessageRequest == null ? new WsRestReceiveMessageRequest()
                : wsRestReceiveMessageRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestReceiveMessageRequest.getClientVersion()), false,
                "clientVersion");

        WsMessageResults wsReceiveMessageResults = new GrouperService(false).receiveMessage(clientVersionString,
                wsRestReceiveMessageRequest.getQueueOrTopicName(), wsRestReceiveMessageRequest.getMessageSystemName(),
                wsRestReceiveMessageRequest.getRoutingKey(), wsRestReceiveMessageRequest.isAutocreateObjects(),
                wsRestReceiveMessageRequest.getBlockMillis(),
                wsRestReceiveMessageRequest.getMaxMessagesToReceiveAtOnce(),
                wsRestReceiveMessageRequest.getActAsSubjectLookup(), wsRestReceiveMessageRequest.getParams());
    ...
    @ApiOperation(value = ".", notes = "", tags = { "rest", "groups" })
    public static WsMessageAcknowledgeResults acknowledgeMessages(GrouperVersion clientVersion,
        ...
        wsRestMessageAcknowledgeRequest = wsRestMessageAcknowledgeRequest == null
                ? new WsRestAcknowledgeMessageRequest()
                : wsRestMessageAcknowledgeRequest;

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestMessageAcknowledgeRequest.getClientVersion()), false,
                "clientVersion");

        WsMessageAcknowledgeResults results = new GrouperService(false).acknowledge(clientVersionString,
                wsRestMessageAcknowledgeRequest.getQueueOrTopicName(),
                wsRestMessageAcknowledgeRequest.getMessageSystemName(),
                wsRestMessageAcknowledgeRequest.getAcknowledgeType(), wsRestMessageAcknowledgeRequest.getMessageIds(),
                wsRestMessageAcknowledgeRequest.getAnotherQueueOrTopicName(),
                wsRestMessageAcknowledgeRequest.getAnotherQueueType(),
                wsRestMessageAcknowledgeRequest.getActAsSubjectLookup(), wsRestMessageAcknowledgeRequest.getParams());
     ...
     * 
     * @param clientVersion                     version of client, e.g. v1_3_000
     * @param wsRestFindExternalSubjectsRequest is the request body converted to an
     *                                          object
     * @return the results
     */
    @POST
    @Path("externalSubjects/find")
    @ApiOperation(value = ".", notes = "", tags = { "rest", "externalSubjects" })
    public static WsFindExternalSubjectsResults findExternalSubjects(GrouperVersion clientVersion,
        ...
        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestFindExternalSubjectsRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsFindExternalSubjectsResults wsFindExternalSubjectsResults = new GrouperService(false).findExternalSubjects(
                ...
                wsRestFindExternalSubjectsRequest.getActAsSubjectLookup(),
     ...
     * 
     * @param clientVersion                      version of client, e.g. v1_3_000
     * @param wsRestExternalSubjectDeleteRequest is the request body converted to an
     *                                           object
     * @return the result
     */
    @POST
    ...
    public static WsExternalSubjectDeleteResults externalSubjectDelete(GrouperVersion clientVersion,
        ...
        // cant be null
        GrouperUtil.assertion(wsRestExternalSubjectDeleteRequest != null, "Body of request must contain an instance of "
                + WsRestExternalSubjectDeleteRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestExternalSubjectDeleteRequest.getClientVersion()), false,
                "clientVersion");
        ...
        WsExternalSubjectDeleteResults wsExternalSubjectDeleteResults = new GrouperService(false).externalSubjectDelete(
                ...
                wsRestExternalSubjectDeleteRequest.getActAsSubjectLookup(),
                wsRestExternalSubjectDeleteRequest.getTxType(), wsRestExternalSubjectDeleteRequest.getParams());
     ...
     * 
     * @param clientVersion                    version of client, e.g. v1_3_000
     * @param wsRestExternalSubjectSaveRequest is the request body converted to an
     *                                         object
     * @return the result
     */
    @POST
    @Path("externalSubjects/save")
    @ApiOperation(value = ".", notes = "", tags = { "rest", "externalSubjects" })
    public static WsExternalSubjectSaveResults externalSubjectSave(GrouperVersion clientVersion,
        ...
        // cant be null
        GrouperUtil.assertion(wsRestExternalSubjectSaveRequest != null, "Body of request must contain an instance of "
                + WsRestExternalSubjectSaveRequest.class.getSimpleName() + " in xml, xhtml, json, etc");

        String clientVersionString = GrouperServiceUtils.pickOne(clientVersion.toString(),
                GrouperVersion.stringValueOrNull(wsRestExternalSubjectSaveRequest.getClientVersion()), false,
                "clientVersion");
